...
REPORT_FILE="$REPORT_DIR/reliability-validation-report.json"
mkdir -p "$REPORT_DIR"
...
run_gate "ops:unit" npx vitest run --project server server/ops/__tests__/ops-control-plane.test.ts
