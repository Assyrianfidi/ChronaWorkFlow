...
console.log('Rounded value:', Math.round(convertedAmount * Math.pow(10, precision)));
...
console.log('Rounded value:', Math.round(convertedAmount * Math.pow(10, precisionZero)));
