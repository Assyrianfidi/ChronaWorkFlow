    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            index_js_1.db.insert(schema_js_1.users).values(newUser).returning(),
          ];
        case 1:
          ...
          return [
            ...
            index_js_1.db
              ...
              .where(
                (0, drizzle_orm_1.eq)(schema_js_1.users.id, createdUser.id),
              ),
          ];
        case 2:
          foundUser = _a.sent();
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          if (!connectionSuccess) {
            console.error(
              "❌ Database tests aborted due to connection failure",
            );
            process.exit(1);
          }
        ...
        case 2:
          ...
          console.log("\n📊 Test Results:");
          console.log(
            "- Database Connection: ".concat(
              connectionSuccess ? "✅ PASSED" : "❌ FAILED",
            ),
          );
          console.log(
            "- User Repository: ".concat(
              repositorySuccess ? "✅ PASSED" : "❌ FAILED",
            ),
          );
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            (0, index_js_1.closeConnection)().catch(console.error),
          ];
        case 1:
          _a.sent();
          process.exit(1);
