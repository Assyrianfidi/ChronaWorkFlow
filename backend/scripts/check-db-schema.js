        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, index_js_1.db.execute((0, drizzle_orm_1.sql)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT NOW() as now"], ["SELECT NOW() as now"]))))];
                case 1:
                    now = _d.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, index_js_1.db.execute((0, drizzle_orm_1.sql)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n        SELECT column_name, data_type, is_nullable, column_default\n        FROM information_schema.columns \n        WHERE table_schema = 'public' AND table_name = ", "\n        ORDER BY ordinal_position;\n      "], ["\n        SELECT column_name, data_type, is_nullable, column_default\n        FROM information_schema.columns \n        WHERE table_schema = 'public' AND table_name = ", "\n        ORDER BY ordinal_position;\n      "])), table.table_name))];
                case 4:
                    columns = _d.sent();
                    console.log('Columns:');
