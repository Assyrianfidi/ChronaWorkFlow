...
var _a = require('../../middleware/security/auditLogger.middleware.js'), logAllRequests = _a.logAllRequests, logPerformance = _a.logPerformance;
describe('Audit Logger Integration Tests', function () {
    ...
    describe('Basic Functionality', function () {
        ...
        it('should have routes defined', function () {
            ...
            expect(routes.some(function (r) { return r.path === '/test'; })).toBe(true);
            expect(routes.some(function (r) { return r.path === '/slow'; })).toBe(true);
        });
        it('should handle middleware execution', function () { return __awaiter(void 0, void 0, void 0, function () {
