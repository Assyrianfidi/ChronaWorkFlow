...
var mockGetMetrics = jest.fn().mockReturnValue({
    ...
    system: { uptime: 1000, memoryUsage: { heapUsed: 50000000 }, cpuUsage: { user: 0, system: 0 } }
});
...
describe('Audit Logger Middleware', function () {
    ...
    beforeEach(function () {
        ...
        app.post('/auth/login', mockAuth, (0, auditLogger_middleware_js_1.logAuthEvent)('LOGIN', true), function (req, res) { return res.json({ success: true, data: { user: { id: 1 } } }); });
        app.post('/auth/login-failed', mockAuth, (0, auditLogger_middleware_js_1.logAuthEvent)('LOGIN', false), function (req, res) { return res.json({ success: false, message: 'Invalid credentials' }); });
        app.post('/accounts', mockAuth, (0, auditLogger_middleware_js_1.logDataEvent)('CREATE', 'ACCOUNT'), function (req, res) { return res.json({ success: true, data: { id: 1, name: 'Test Account' } }); });
        app.delete('/accounts/:id', mockAuth, (0, auditLogger_middleware_js_1.logDataEvent)('DELETE', 'ACCOUNT'), function (req, res) { return res.json({ success: true }); });
        app.get('/sensitive', mockAuth, (0, auditLogger_middleware_js_1.logSecurityEvent)('UNAUTHORIZED_ACCESS', { resource: 'sensitive_data' }), function (req, res) { return res.json({ success: true }); });
    });
    describe('Auth Event Logging', function () {
        it('should log successful login events', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expect(MockedAuditLoggerService.logAuthEvent).toHaveBeenCalledWith(expect.objectContaining({
                            action: 'LOGIN',
                            userId: 1,
                        ...
                        expect(mockRecordAuthMetrics).toHaveBeenCalledWith(expect.objectContaining({
                            action: 'LOGIN',
                            success: true,
                            userId: 1
                        }));
        ...
        it('should log failed login events', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Data Event Logging', function () {
        it('should log account creation events', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        response = _a.sent();
                        expect(response.status).toBe(200);
                        expect(MockedAuditLoggerService.logDataEvent).toHaveBeenCalledWith(expect.objectContaining({
                            action: 'CREATE',
        ...
        it('should log account deletion events with warning severity', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('Security Event Logging', function () {
        it('should log security events immediately', function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        response = _a.sent();
                        expect(response.status).toBe(200);
                        expect(MockedAuditLoggerService.logSecurityEvent).toHaveBeenCalledWith(expect.objectContaining({
...
describe('Monitoring Service', function () {
    ...
    describe('Metrics Collection', function () {
        ...
        it('should record authentication metrics', function () {
            mockMonitoringService.recordAuthMetrics({ action: 'LOGIN', success: true });
            mockMonitoringService.recordAuthMetrics({ action: 'LOGIN_FAILED', success: false });
            mockMonitoringService.recordAuthMetrics({ action: 'PASSWORD_CHANGE', success: true });
            expect(mockRecordAuthMetrics).toHaveBeenCalledTimes(3);
        });
        it('should record security metrics', function () {
            mockMonitoringService.recordSecurityMetrics({ action: 'UNAUTHORIZED_ACCESS' });
            mockMonitoringService.recordSecurityMetrics({ action: 'RATE_LIMIT_EXCEEDED' });
...
describe('Audit Logger Service', function () {
    ...
    describe('Auth Event Logging', function () {
        it('should log authentication events with correct structure', function () { return __awaiter(void 0, void 0, void 0, function () {
            var event;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, MockedAuditLoggerService.logAuthEvent(event)];
                    case 1:
                        _a.sent();
    ...
    describe('Data Event Logging', function () {
        it('should log data events with sensitive flag for important resources', function () { return __awaiter(void 0, void 0, void 0, function () {
            var event;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, MockedAuditLoggerService.logDataEvent(event)];
                    case 1:
                        _a.sent();
    ...
    describe('Security Event Logging', function () {
        it('should log security events and trigger alerts', function () { return __awaiter(void 0, void 0, void 0, function () {
            var event;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, MockedAuditLoggerService.logSecurityEvent(event)];
                    case 1:
                        _a.sent();
                        expect(MockedAuditLoggerService.logSecurityEvent).toHaveBeenCalledWith(event);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('Audit Log Retrieval', function () {
        it('should filter audit logs by various criteria', function () {
            ...
            expect(MockedAuditLoggerService.getAuditLogs).toHaveBeenCalledWith(filters);
        });
        it('should get audit statistics', function () {
            var period = { days: 7 };
            MockedAuditLoggerService.getAuditStatistics(period);
            expect(MockedAuditLoggerService.getAuditStatistics).toHaveBeenCalledWith(period);
        });
    });
    describe('Security Alerts', function () {
        it('should retrieve security alerts with filters', function () {
            ...
            expect(MockedAuditLoggerService.getSecurityAlerts).toHaveBeenCalledWith(filters);
        });
        it('should acknowledge security alerts', function () {
            var alertId = '2024-01-01T00:00:00.000Z';
            var userId = 'admin-user';
            MockedAuditLoggerService.acknowledgeAlert(alertId, userId);
            expect(MockedAuditLoggerService.acknowledgeAlert).toHaveBeenCalledWith(alertId, userId);
        });
    });
    describe('Export Functionality', function () {
        it('should export audit logs with filters', function () {
            ...
            expect(MockedAuditLoggerService.exportAuditLogs).toHaveBeenCalledWith(filters);
        });
    });
});
