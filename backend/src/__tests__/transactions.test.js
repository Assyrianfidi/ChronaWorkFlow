...
describe("Transactions Module", function () {
  ...
  describe("TransactionsService", function () {
    describe("list", function () {
      it("should list transactions for a company", function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  transactions_service_js_1.transactionsService.list(
                    "company-1",
                    50,
                  ),
                ];
    ...
    describe("create", function () {
      it("should create a balanced transaction", function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                mockPrisma.$transaction.mockImplementation(function (callback) {
                  return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                      ...
                      mockPrisma.transactionLine.create.mockResolvedValue(
                        mockLines[0],
                      );
                ...
                return [
                  4 /*yield*/,
                  transactions_service_js_1.transactionsService.create(
                    transactionData,
                    "user-1",
                  ),
                ];
              case 1:
                ...
                expect(mockPrisma.transactionLine.create).toHaveBeenCalledTimes(
                  2,
                );
                return [2 /*return*/];
            }
      ...
      it("should throw error for unbalanced transaction", function () {
        return __awaiter(void 0, void 0, void 0, function () {
          var transactionData;
          return __generator(this, function (_a) {
            switch (_a.label) {
  ...
  describe("TransactionsController", function () {
    describe("list", function () {
      it("should return transactions list", function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  transactions_controller_js_1.transactionsController.list(
                    mockRequest,
                    mockResponse,
                    nextFunction,
                  ),
    ...
    describe("create", function () {
      it("should create and return transaction", function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  transactions_controller_js_1.transactionsController.create(
                    mockRequest,
                    mockResponse,
                    nextFunction,
                  ),
      ...
      it("should handle balance validation errors", function () {
        return __awaiter(void 0, void 0, void 0, function () {
          var transactionData;
          return __generator(this, function (_a) {
            switch (_a.label) {
