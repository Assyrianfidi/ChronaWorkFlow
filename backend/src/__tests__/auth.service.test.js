          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              ((password = createdUser.password),
                (expectedUser = __rest(createdUser, ["password"])));
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              ((password = mockUserWithPassword.password),
                (userWithoutPassword = __rest(mockUserWithPassword, [
                  "password",
                ])));
              expect(result).toEqual(
                __assign(__assign({}, userWithoutPassword), {
                  token: "test-token",
                }),
              );
              return [2 /*return*/];
