...
describe("Circuit Breaker", function () {
  ...
  describe("CircuitBreaker Class", function () {
    ...
    it("should start in CLOSED state", function () {
      expect(circuitBreaker.getState()).toBe(
        circuitBreaker_1.CircuitState.CLOSED,
      );
    });
    it("should execute successful calls", function () {
    ...
    it("should open circuit after failure threshold", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 6:
              expect(circuitBreaker.getState()).toBe(
                circuitBreaker_1.CircuitState.OPEN,
              );
              return [2 /*return*/];
          }
        });
    ...
    it("should reject calls when circuit is OPEN", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 6:
              ...
              return [
                4 /*yield*/,
                expect(circuitBreaker.execute(anotherFn)).rejects.toThrow(
    ...
    it("should transition to HALF_OPEN after reset timeout", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 8:
              _a.sent();
              expect(circuitBreaker.getState()).toBe(
                circuitBreaker_1.CircuitState.HALF_OPEN,
              );
              expect(successFn).toHaveBeenCalled();
              return [2 /*return*/];
          }
    ...
    it("should close circuit after successful calls in HALF_OPEN", function () {
      return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("should open circuit again on failure in HALF_OPEN", function () {
      return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("should provide correct statistics", function () {
      return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("should reset manually", function () {
      return __awaiter(void 0, void 0, void 0, function () {
  ...
  describe("CircuitBreakerRegistry", function () {
    ...
    it("should check for open circuits", function () {
      var breaker1 = circuitBreaker_1.CircuitBreakerRegistry.get("service1");
      var breaker2 = circuitBreaker_1.CircuitBreakerRegistry.get("service2");
      expect(circuitBreaker_1.CircuitBreakerRegistry.hasOpenCircuits()).toBe(
        false,
      );
      breaker1.open();
      expect(circuitBreaker_1.CircuitBreakerRegistry.hasOpenCircuits()).toBe(
  ...
  describe("withCircuitBreaker decorator", function () {
    ...
    it.skip("should execute wrapped methods through circuit breaker", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [2 /*return*/];
        });
