...
(0, globals_1.describe)("Performance Layer Tests", function () {
  ...
  (0, globals_1.describe)("CacheEngine", function () {
    ...
    (0, globals_1.it)(
      "should handle get operation when not connected",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, cacheEngine_1.CacheEngine.get("test-key")];
              case 1:
                result = _a.sent();
    ...
    (0, globals_1.it)(
      "should handle set operation when not connected",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4 /*yield*/,
                  (0, globals_1.expect)(
                    cacheEngine_1.CacheEngine.set("test-key", "value", 300),
    ...
    (0, globals_1.it)(
      "should handle delete operation when not connected",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4 /*yield*/,
                  (0, globals_1.expect)(
                    cacheEngine_1.CacheEngine.del("test-key"),
                  ).resolves.toBeUndefined(),
                ];
              case 1:
                _a.sent();
    ...
    (0, globals_1.it)(
      "should handle pattern delete when not connected",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4 /*yield*/,
                  (0, globals_1.expect)(
                    cacheEngine_1.CacheEngine.delPattern("test-*"),
                  ).resolves.toBeUndefined(),
                ];
              case 1:
                _a.sent();
    ...
    (0, globals_1.it)(
      "should handle increment operation when not connected",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          var result;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [4 /*yield*/, cacheEngine_1.CacheEngine.incr("counter")];
              case 1:
                result = _a.sent();
    ...
    (0, globals_1.it)(
      "should handle exists check when not connected",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          var result;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                return [
                  4 /*yield*/,
                  cacheEngine_1.CacheEngine.exists("test-key"),
                ];
              case 1:
                result = _a.sent();
  ...
  (0, globals_1.describe)("CacheInvalidator", function () {
    (0, globals_1.it)("should invalidate user caches", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var delPatternSpy;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              delPatternSpy = globals_1.jest.spyOn(
                cacheEngine_1.CacheEngine,
                "delPattern",
              );
              return [
                4 /*yield*/,
                cacheEngine_1.CacheInvalidator.invalidateUser("user123"),
              ];
            case 1:
              _a.sent();
              (0, globals_1.expect)(delPatternSpy).toHaveBeenCalledWith(
                "user:user123:*",
              );
              (0, globals_1.expect)(delPatternSpy).toHaveBeenCalledWith(
                "transactions:user:user123:*",
              );
              (0, globals_1.expect)(delPatternSpy).toHaveBeenCalledWith(
                "balances:user:user123:*",
              );
              return [2 /*return*/];
          }
        });
    ...
    (0, globals_1.it)("should invalidate account caches", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var delPatternSpy;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                cacheEngine_1.CacheInvalidator.invalidateAccount("acc123"),
              ];
            case 1:
              _a.sent();
              (0, globals_1.expect)(delPatternSpy).toHaveBeenCalledWith(
    ...
    (0, globals_1.it)("should invalidate transaction caches", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                cacheEngine_1.CacheInvalidator.invalidateTransaction("txn123"),
              ];
            case 1:
              _a.sent();
              (0, globals_1.expect)(delSpy).toHaveBeenCalledWith(
                "transaction:txn123",
              );
              (0, globals_1.expect)(delPatternSpy).toHaveBeenCalledWith(
                "transactions:*:txn123:*",
    ...
    (0, globals_1.it)(
      "should invalidate all financial data caches",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          var delPatternSpy;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  cacheEngine_1.CacheInvalidator.invalidateFinancialData(),
                ];
              case 1:
                _a.sent();
                (0, globals_1.expect)(delPatternSpy).toHaveBeenCalledWith(
  ...
  (0, globals_1.describe)("CacheMiddleware", function () {
    (0, globals_1.it)("should cache method results", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              target = {
                expensiveMethod: globals_1.jest
                  .fn()
                  .mockResolvedValue("result"),
              };
              // Apply decorator
              cacheEngine_1.CacheMiddleware.cacheResponse(300)(
                target,
                "expensiveMethod",
                {
              ...
              getSpy = globals_1.jest
                .spyOn(cacheEngine_1.CacheEngine, "get")
                .mockResolvedValue(null);
              setSpy = globals_1.jest
                .spyOn(cacheEngine_1.CacheEngine, "set")
                .mockResolvedValue();
              return [4 /*yield*/, target.expensiveMethod("arg1", "arg2")];
            case 1:
              result = _a.sent();
              (0, globals_1.expect)(result).toBe("result");
              (0, globals_1.expect)(getSpy).toHaveBeenCalledWith(
                'expensiveMethod:["arg1","arg2"]',
              );
              (0, globals_1.expect)(setSpy).toHaveBeenCalledWith(
                'expensiveMethod:["arg1","arg2"]',
                "result",
                300,
              );
    ...
    (0, globals_1.it)("should check rate limits correctly", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var checkRateLimitSpy, result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              checkRateLimitSpy = globals_1.jest.spyOn(
                cacheEngine_1.CacheEngine,
                "checkRateLimit",
              );
              ...
              return [
                4 /*yield*/,
                cacheEngine_1.CacheMiddleware.checkRateLimit("user123", 10, 60),
              ];
            case 1:
              result = _a.sent();
              (0, globals_1.expect)(result.allowed).toBe(true);
              (0, globals_1.expect)(result.remaining).toBe(5);
              (0, globals_1.expect)(checkRateLimitSpy).toHaveBeenCalledWith(
                "user123",
                10,
                60,
              );
  ...
  (0, globals_1.describe)("RateLimiter", function () {
    ...
    (0, globals_1.it)(
      "should create per-user rate limiter with custom limits",
      function () {
        var middleware = rateLimiter_1.RateLimiter.perUserLimit("auth", {
          requests: 3,
          window: 120,
        });
        (0, globals_1.expect)(typeof middleware).toBe("function");
    ...
    (0, globals_1.it)("should update IP reputation", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var setSpy;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                rateLimiter_1.RateLimiter.updateIPReputation(
                  "192.168.1.1",
                  "good",
                ),
              ];
  ...
  (0, globals_1.describe)("RateLimitMiddleware", function () {
    (0, globals_1.it)("should combine multiple rate limiters", function () {
      ...
      var combined = rateLimiter_1.RateLimitMiddleware.combine(
        limiter1,
        limiter2,
      );
  ...
  (0, globals_1.describe)("PaginationEngine", function () {
    ...
    (0, globals_1.it)("should paginate with offset", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                paginationEngine_1.PaginationEngine.paginateWithOffset(
                  mockModel,
                  { page: 1, limit: 20 },
                  { userId: "user123" },
                ),
    ...
    (0, globals_1.it)("should paginate with cursor", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                paginationEngine_1.PaginationEngine.paginateWithCursor(
                  mockModel,
    ...
    (0, globals_1.it)("should validate pagination parameters", function () {
      (0, globals_1.expect)(function () {
        return paginationEngine_1.PaginationEngine.validatePaginationParams({
          page: 0,
        });
      }).toThrow();
      (0, globals_1.expect)(function () {
    ...
    (0, globals_1.it)("should validate sort parameters", function () {
      (0, globals_1.expect)(function () {
        return paginationEngine_1.PaginationEngine.validateSortParams(
          { sortBy: "invalid" },
          ["id", "name"],
        );
      }).toThrow();
    ...
    (0, globals_1.it)("should create pagination metadata", function () {
      ...
      var meta = paginationEngine_1.PaginationEngine.createPaginationMeta(
        pagination,
  ...
  (0, globals_1.describe)("FilterEngine", function () {
    (0, globals_1.it)(
      "should build filters from query parameters",
      function () {
        var _a, _b, _c, _d;
        var query = {
          search: "test",
        ...
        (0, globals_1.expect)(
          (_a = filters.dateRange) === null || _a === void 0
            ? void 0
            : _a.start,
        ).toBeInstanceOf(Date);
        (0, globals_1.expect)(
          (_b = filters.dateRange) === null || _b === void 0 ? void 0 : _b.end,
        ).toBeInstanceOf(Date);
        (0, globals_1.expect)(
          (_c = filters.numericRange) === null || _c === void 0
            ? void 0
            : _c.min,
        ).toBe(100);
        (0, globals_1.expect)(
          (_d = filters.numericRange) === null || _d === void 0
            ? void 0
            : _d.max,
        ).toBe(1000);
    ...
    (0, globals_1.it)("should validate filters", function () {
      (0, globals_1.expect)(function () {
        return paginationEngine_1.FilterEngine.validateFilters({
          dateRange: {
  ...
  (0, globals_1.describe)("PerformanceMonitor", function () {
    ...
    (0, globals_1.it)("should start and stop timer", function () {
      var endTimer =
        performanceMonitor_1.PerformanceMonitor.startTimer("test-operation");
      // Simulate some work
      setTimeout(function () {}, 10);
      var metric = endTimer();
      (0, globals_1.expect)(metric.name).toBe("test-operation");
      (0, globals_1.expect)(metric.duration).toBeGreaterThanOrEqual(0);
      (0, globals_1.expect)(metric.startTime).toBeLessThanOrEqual(
        metric.endTime,
      );
    });
    (0, globals_1.it)("should get performance statistics", function () {
      ...
      endTimer2();
      var stats =
        performanceMonitor_1.PerformanceMonitor.getStats("test-operation");
    ...
    (0, globals_1.it)("should monitor database queries", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var queryFn, result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                performanceMonitor_1.PerformanceMonitor.monitorQuery(
                  "test-query",
                  queryFn,
                ),
              ];
    ...
    (0, globals_1.it)("should monitor cache operations", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                performanceMonitor_1.PerformanceMonitor.monitorCache(
                  "get",
                  "test-key",
                  operationFn,
                ),
    ...
    (0, globals_1.it)("should create performance middleware", function () {
      var middleware =
        performanceMonitor_1.PerformanceMonitor.performanceMiddleware();
      (0, globals_1.expect)(typeof middleware).toBe("function");
    });
  });
  (0, globals_1.describe)("LoadTester", function () {
    (0, globals_1.it)("should run concurrent requests", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                performanceMonitor_1.LoadTester.runConcurrentRequests(
            ...
            case 1:
              ...
              (0, globals_1.expect)(result.requestsPerSecond).toBeGreaterThan(
                0,
              );
    ...
    (0, globals_1.it)(
      "should handle errors in concurrent requests",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          var result;
          return __generator(this, function (_a) {
    ...
    (0, globals_1.it)("should run stress test", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                performanceMonitor_1.LoadTester.runStressTest(
                  "https://api.example.com/test",
                  {
                    startConcurrency: 1,
                    maxConcurrency: 3,
            ...
            case 1:
              ...
              (0, globals_1.expect)(
                result.maxSustainedConcurrency,
  ...
  (0, globals_1.describe)("DatabaseMonitor", function () {
    ...
    (0, globals_1.it)("should get connection pool stats", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var stats;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                performanceMonitor_1.DatabaseMonitor.getConnectionPoolStats(
                  mockPrisma,
                ),
              ];
            case 1:
    ...
    (0, globals_1.it)("should handle connection pool stats error", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var stats;
        return __generator(this, function (_a) {
          switch (_a.label) {
    ...
    (0, globals_1.it)("should get slow queries", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var slowQueries;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                performanceMonitor_1.DatabaseMonitor.getSlowQueries(
                  mockPrisma,
                  1000,
                ),
              ];
            case 1:
              ...
              (0, globals_1.expect)(slowQueries[0].mean_time).toBeGreaterThan(
                1000,
              );
              return [2 /*return*/];
          }
    ...
    (0, globals_1.it)("should handle slow queries error", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var slowQueries;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                performanceMonitor_1.DatabaseMonitor.getSlowQueries(mockPrisma),
              ];
            case 1:
              slowQueries = _a.sent();
