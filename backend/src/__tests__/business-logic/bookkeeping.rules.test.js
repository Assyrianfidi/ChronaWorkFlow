...
describe('Bookkeeping Rules', function () {
    describe('validateDoubleEntry', function () {
        it('should validate a balanced transaction', function () {
            ...
            expect(function () { return bookkeeping_rules_1.BookkeepingRules.validateDoubleEntry(transaction); }).not.toThrow();
        });
        it('should reject transaction with less than 2 entries', function () {
            ...
            expect(function () { return bookkeeping_rules_1.BookkeepingRules.validateDoubleEntry(transaction); })
    ...
    describe('createTransferTransaction', function () {
        it('should create a valid transfer transaction', function () {
            var transaction = bookkeeping_rules_1.BookkeepingRules.createTransferTransaction('acc1', 'acc2', 100, 'Test transfer', 'user1', 'REF123');
            ...
            // Check debit entry
            var debitEntry = transaction.entries.find(function (e) { return e.debit; });
            ...
            // Check credit entry
            var creditEntry = transaction.entries.find(function (e) { return e.credit; });
    ...
    describe('createFeeTransaction', function () {
        it('should create a valid fee transaction', function () {
            var transaction = bookkeeping_rules_1.BookkeepingRules.createFeeTransaction('acc1', 5.50, 'fee-revenue', 'Transaction fee', 'user1');
            expect(transaction.entries).toHaveLength(2);
    ...
    describe('createInterestTransaction', function () {
        it('should create a valid interest transaction', function () {
            var transaction = bookkeeping_rules_1.BookkeepingRules.createInterestTransaction('acc1', 10.00, 'interest-payable', 'Interest earned', 'user1');
            expect(transaction.entries).toHaveLength(2);
    ...
    describe('calculateBalance', function () {
        it('should calculate account balance correctly', function () {
            ...
            var balance = bookkeeping_rules_1.BookkeepingRules.calculateBalance(entries, 'acc1');
    ...
    describe('validateAccountConstraints', function () {
        it('should allow valid transaction', function () {
            ...
            expect(function () { return bookkeeping_rules_1.BookkeepingRules.validateAccountConstraints(transaction, accountBalances, accountTypes); })
                .not.toThrow();
        });
    ...
    describe('reverseTransaction', function () {
        it('should create reversing transaction', function () {
            ...
            var reversal = bookkeeping_rules_1.BookkeepingRules.reverseTransaction(originalTransaction, 'Customer request', 'user1');
            expect(reversal.description).toContain('Reversal of txn1');
            expect(reversal.reference).toBe('txn1');
            expect((_a = reversal.metadata) === null || _a === void 0 ? void 0 : _a.originalTransactionId).toBe('txn1');
            expect((_b = reversal.metadata) === null || _b === void 0 ? void 0 : _b.reversalReason).toBe('Customer request');
            // Check that debits and credits are swapped
            var originalDebit = originalTransaction.entries.find(function (e) { return e.debit; });
            var reversalDebit = reversal.entries.find(function (e) { return e.debit && e.accountId === originalDebit.accountId; });
            expect(reversalDebit).toBeUndefined(); // Should be credit now
            var reversalCredit = reversal.entries.find(function (e) { return e.credit && e.accountId === originalDebit.accountId; });
    ...
    describe('validateTrialBalance', function () {
        it('should validate balanced trial balance', function () {
            ...
            expect(function () { return bookkeeping_rules_1.BookkeepingRules.validateTrialBalance(accountBalances); }).not.toThrow();
        });
        it('should reject unbalanced trial balance', function () {
            ...
            expect(function () { return bookkeeping_rules_1.BookkeepingRules.validateTrialBalance(accountBalances); })
    ...
    describe('createAdjustingEntry', function () {
        it('should create adjusting entry with clearing account', function () {
            var _a;
            var transaction = bookkeeping_rules_1.BookkeepingRules.createAdjustingEntry('acc1', 100, true, 'Adjustment for depreciation', 'user1');
            expect(transaction.entries).toHaveLength(2);
            expect(transaction.description).toBe('Adjusting entry: Adjustment for depreciation');
            expect((_a = transaction.metadata) === null || _a === void 0 ? void 0 : _a.isAdjustingEntry).toBe(true);
            // Check main entry
            var mainEntry = transaction.entries.find(function (e) { return e.accountId === 'acc1'; });
            expect(mainEntry.debit).toBe(true);
            expect(mainEntry.credit).toBe(false);
            // Check clearing entry
            var clearingEntry = transaction.entries.find(function (e) { return e.accountId === 'ADJUSTMENT_CLEARING'; });
...
describe('TransactionTemplates', function () {
    describe('bankTransfer', function () {
        it('should create bank transfer transaction', function () {
            var txn = bookkeeping_rules_1.TransactionTemplates.bankTransfer('acc1', 'acc2', 100, 'user1', 'REF123');
    ...
    describe('atmWithdrawal', function () {
        it('should create ATM withdrawal with fee', function () {
            var result = bookkeeping_rules_1.TransactionTemplates.atmWithdrawal('acc1', 100, 2.50, 'fee-revenue', 'user1');
    ...
    describe('interestBearingDeposit', function () {
        it('should create deposit with interest', function () {
            var result = bookkeeping_rules_1.TransactionTemplates.interestBearingDeposit('acc1', 1000, 5.00, 'interest-payable', 'user1');
