...
describe("Financial Calculator", () => {
  describe("convertCurrency", () => {
    it("should convert currency correctly", () => {
      const result = FinancialCalculator.convertCurrency(
        100,
        "USD",
        "EUR",
        0.85,
    ...
    it("should reject negative amounts", () => {
      expect(() =>
        FinancialCalculator.convertCurrency(-100, "USD", "EUR", 0.85),
      ).toThrow("Cannot convert negative amounts");
    });

    it("should reject zero or negative exchange rate", () => {
      expect(() =>
        FinancialCalculator.convertCurrency(100, "USD", "EUR", 0),
      ).toThrow("Exchange rate must be positive");

      expect(() =>
        FinancialCalculator.convertCurrency(100, "USD", "EUR", -0.5),
      ).toThrow("Exchange rate must be positive");
    });
  });
  ...
  describe("calculateTax", () => {
    ...
    it("should reject negative amounts", () => {
      expect(() => FinancialCalculator.calculateTax(-100, 0.08)).toThrow(
        "Cannot calculate tax on negative amount",
      );
    });

    it("should reject tax rate outside 0-1 range", () => {
      expect(() => FinancialCalculator.calculateTax(100, -0.1)).toThrow(
        "Tax rate must be between 0 and 1 (0-100%)",
      );

      expect(() => FinancialCalculator.calculateTax(100, 1.5)).toThrow(
        "Tax rate must be between 0 and 1 (0-100%)",
      );
    });
  });
  ...
  describe("calculateInterest", () => {
    it("should calculate compound interest correctly", () => {
      const result = FinancialCalculator.calculateInterest(
        1000,
        0.05,
        365,
        "daily",
    ...
    it("should calculate simple interest correctly", () => {
      const result = FinancialCalculator.calculateSimpleInterest(
        1000,
        0.05,
        365,
      );
    ...
    it("should reject negative parameters", () => {
      expect(() =>
        FinancialCalculator.calculateInterest(-1000, 0.05, 365),
  ...
  describe("calculateBalanceSummary", () => {
    it("should calculate balance summary correctly", () => {
      const result = FinancialCalculator.calculateBalanceSummary(
        1000,
        200,
        100,
        50,
  ...
  describe("calculateConversionWithSpread", () => {
    it("should calculate conversion with spread", () => {
      const result = FinancialCalculator.calculateConversionWithSpread(
        100,
        1.2,
        0.02,
      );
  ...
  describe("calculateMonthlyPayment", () => {
    it("should calculate loan payment correctly", () => {
      const result = FinancialCalculator.calculateMonthlyPayment(
        100000,
        0.05,
        360,
      );
    ...
    it("should reject invalid parameters", () => {
      expect(() =>
        FinancialCalculator.calculateMonthlyPayment(-1000, 0.05, 360),
      ...
      expect(() =>
        FinancialCalculator.calculateMonthlyPayment(1000, 0.05, -12),
      ).toThrow("Invalid loan parameters");
    });
  });
  ...
  describe("calculateIRR", () => {
    ...
    it("should throw if IRR calculation fails to converge", () => {
      ...
      expect(() => FinancialCalculator.calculateIRR(cashFlows)).toThrow(
...
describe("FinancialCalculations", () => {
  describe("convertCurrency", () => {
    it("should be an alias to FinancialCalculator.convertCurrency", () => {
      const result = FinancialCalculations.convertCurrency(
        100,
        "USD",
        "EUR",
        0.85,
  ...
  describe("calculateLoanDetails", () => {
    it("should provide complete loan details", () => {
      const result = FinancialCalculations.calculateLoanDetails(
        100000,
        0.05,
        360,
      );
