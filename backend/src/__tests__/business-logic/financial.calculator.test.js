...
describe('Financial Calculator', function () {
    describe('convertCurrency', function () {
        it('should convert currency correctly', function () {
            var result = financial_calculator_1.FinancialCalculator.convertCurrency(100, 'USD', 'EUR', 0.85);
        ...
        it('should reject negative amounts', function () {
            expect(function () { return financial_calculator_1.FinancialCalculator.convertCurrency(-100, 'USD', 'EUR', 0.85); })
                .toThrow('Cannot convert negative amounts');
        });
        it('should reject zero or negative exchange rate', function () {
            expect(function () { return financial_calculator_1.FinancialCalculator.convertCurrency(100, 'USD', 'EUR', 0); })
                .toThrow('Exchange rate must be positive');
            expect(function () { return financial_calculator_1.FinancialCalculator.convertCurrency(100, 'USD', 'EUR', -0.5); })
                .toThrow('Exchange rate must be positive');
        });
    });
    describe('calculateTax', function () {
        it('should calculate tax correctly', function () {
            var result = financial_calculator_1.FinancialCalculator.calculateTax(100, 0.08);
        ...
        it('should handle zero tax rate', function () {
            var result = financial_calculator_1.FinancialCalculator.calculateTax(100, 0);
            expect(result).toEqual({
                amount: 100,
                taxRate: 0,
                taxAmount: 0.00,
        ...
        it('should reject negative amounts', function () {
            expect(function () { return financial_calculator_1.FinancialCalculator.calculateTax(-100, 0.08); })
                .toThrow('Cannot calculate tax on negative amount');
        });
        it('should reject tax rate outside 0-1 range', function () {
            expect(function () { return financial_calculator_1.FinancialCalculator.calculateTax(100, -0.1); })
                .toThrow('Tax rate must be between 0 and 1 (0-100%)');
            expect(function () { return financial_calculator_1.FinancialCalculator.calculateTax(100, 1.5); })
                .toThrow('Tax rate must be between 0 and 1 (0-100%)');
        });
    });
    describe('calculateInterest', function () {
        it('should calculate compound interest correctly', function () {
            var result = financial_calculator_1.FinancialCalculator.calculateInterest(1000, 0.05, 365, 'daily');
        ...
        it('should calculate simple interest correctly', function () {
            var result = financial_calculator_1.FinancialCalculator.calculateSimpleInterest(1000, 0.05, 365);
        ...
        it('should reject negative parameters', function () {
            expect(function () { return financial_calculator_1.FinancialCalculator.calculateInterest(-1000, 0.05, 365); })
    ...
    describe('calculateBalanceSummary', function () {
        it('should calculate balance summary correctly', function () {
            var result = financial_calculator_1.FinancialCalculator.calculateBalanceSummary(1000, 200, 100, 50);
            expect(result).toEqual({
                accountBalance: 1000,
        ...
        it('should handle zero pending amounts', function () {
            var result = financial_calculator_1.FinancialCalculator.calculateBalanceSummary(1000);
    ...
    describe('calculateTransactionFee', function () {
        it('should calculate fixed fee only', function () {
            var fee = financial_calculator_1.FinancialCalculator.calculateTransactionFee(100, {
                fixedFee: 2.50
            });
        ...
        it('should apply minimum fee', function () {
            var fee = financial_calculator_1.FinancialCalculator.calculateTransactionFee(10, {
                fixedFee: 0.50,
                percentageFee: 0.01,
                minFee: 2.00
            });
        ...
        it('should apply maximum fee', function () {
            var fee = financial_calculator_1.FinancialCalculator.calculateTransactionFee(10000, {
                percentageFee: 0.05,
                maxFee: 25.00
            });
    ...
    describe('calculateConversionWithSpread', function () {
        it('should calculate conversion with spread', function () {
            var result = financial_calculator_1.FinancialCalculator.calculateConversionWithSpread(100, 1.2, 0.02);
    ...
    describe('calculateMonthlyPayment', function () {
        it('should calculate loan payment correctly', function () {
            var result = financial_calculator_1.FinancialCalculator.calculateMonthlyPayment(100000, 0.05, 360);
        ...
        it('should handle zero interest loan', function () {
            var result = financial_calculator_1.FinancialCalculator.calculateMonthlyPayment(12000, 0, 12);
        ...
        it('should reject invalid parameters', function () {
            expect(function () { return financial_calculator_1.FinancialCalculator.calculateMonthlyPayment(-1000, 0.05, 360); })
                .toThrow('Invalid loan parameters');
            expect(function () { return financial_calculator_1.FinancialCalculator.calculateMonthlyPayment(1000, -0.05, 360); })
                .toThrow('Invalid loan parameters');
            expect(function () { return financial_calculator_1.FinancialCalculator.calculateMonthlyPayment(1000, 0.05, -12); })
                .toThrow('Invalid loan parameters');
        });
    });
    describe('calculateAmortizationSchedule', function () {
        it('should generate amortization schedule', function () {
            var schedule = financial_calculator_1.FinancialCalculator.calculateAmortizationSchedule(1000, 0.12, 12);
    ...
    describe('calculateNPV', function () {
        it('should calculate NPV correctly', function () {
            ...
            var npv = financial_calculator_1.FinancialCalculator.calculateNPV(cashFlows, 0.1);
    ...
    describe('calculateIRR', function () {
        it('should calculate IRR correctly', function () {
            var cashFlows = [-1000, 300, 300, 300, 300];
            var irr = financial_calculator_1.FinancialCalculator.calculateIRR(cashFlows, 0.1);
        ...
        it('should throw if IRR calculation fails to converge', function () {
            ...
            expect(function () { return financial_calculator_1.FinancialCalculator.calculateIRR(cashFlows); })
...
describe('FinancialCalculations', function () {
    describe('convertCurrency', function () {
        it('should be an alias to FinancialCalculator.convertCurrency', function () {
            var result = financial_calculator_1.FinancialCalculations.convertCurrency(100, 'USD', 'EUR', 0.85);
            expect(result).toBe(85.00);
        });
    });
    describe('calculateTotalWithFees', function () {
        it('should calculate total with fees', function () {
            var result = financial_calculator_1.FinancialCalculations.calculateTotalWithFees(100, {
                fixedFee: 2.50,
                percentageFee: 0.01
            });
            expect(result).toEqual({
    ...
    describe('calculateLoanDetails', function () {
        it('should provide complete loan details', function () {
            var result = financial_calculator_1.FinancialCalculations.calculateLoanDetails(100000, 0.05, 360);
