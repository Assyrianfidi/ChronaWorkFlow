...
describe("Domain Validator", function () {
  ...
  describe("validateBalance", function () {
    it("should allow sufficient balance", function () {
      var validation = domain_validator_1.DomainValidator.validateBalance(
        1000,
        500,
        "CHECKING",
      );
  ...
  describe("validateCrossCurrencyTransaction", function () {
    it("should allow same currency without exchange rate", function () {
      var validation =
        domain_validator_1.DomainValidator.validateCrossCurrencyTransaction(
          "USD",
          "USD",
          100,
        );
  ...
  describe("validateTransactionTiming", function () {
    it("should allow normal timing", function () {
      ...
      var validation =
        domain_validator_1.DomainValidator.validateTransactionTiming(
          lastTime,
          100,
        );
      expect(validation.isValid).toBe(true);
    ...
    it("should reject too frequent high-value transactions", function () {
      ...
      expect(validation.errors).toContainEqual({
        ...
        value: {
          minutesSinceLastTransaction: expect.any(Number),
          amount: 2000,
        },
      });
    });
  ...
  describe("validateOrThrow", function () {
    it("should throw error for invalid validation", function () {
      ...
      expect(function () {
        return domain_validator_1.DomainValidator.validateOrThrow(
          invalidValidation,
        );
      }).toThrow();
    });
  ...
  describe("ValidationRules", function () {
    it("should validate standard transaction", function () {
      expect(function () {
        return domain_validator_1.ValidationRules.standardTransaction({
          fromAccountId: "acc1",
          toAccountId: "acc2",
          amount: 100,
          currency: "USD",
    ...
    it("should validate high-value transaction with timing check", function () {
      var lastTime = new Date(Date.now() - 10 * 60 * 1000); // 10 minutes ago
      expect(function () {
        return domain_validator_1.ValidationRules.highValueTransaction(
          {
            fromAccountId: "acc1",
            toAccountId: "acc2",
    ...
    it("should validate international transfer", function () {
      expect(function () {
        return domain_validator_1.ValidationRules.internationalTransfer(
          "USD",
          "EUR",
          100,
          0.85,
