...
jest.mock("../../utils/loggingBridge", function () {
  return {
    LoggingBridge: {
...
var mockLogSystemEvent = require("../../utils/loggingBridge").LoggingBridge
  .logSystemEvent;
describe("Fraud Detector", function () {
  ...
  describe("analyzeTransaction", function () {
    it("should approve normal transaction", function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fraud_detector_1.FraudDetector.analyzeTransaction(
                  currentTransaction,
                  historicalPatterns,
                ),
              ];
    ...
    it("should flag large amount transaction", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(
                result.alerts.some(function (a) {
                  return a.alertType === "LARGE_AMOUNT";
                }),
              ).toBe(true);
              expect(
                result.alerts.some(function (a) {
              ...
              if (
                result.alerts.some(function (a) {
                  return a.alertType === "ACCOUNT_TAKEOVER";
                })
              ) {
    ...
    it("should flag rapid transactions", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (
                !result.alerts.some(function (a) {
                  return a.alertType === "RAPID_TRANSACTIONS";
                })
              ) {
    ...
    it("should flag unusual location", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var currentTransaction, historicalPatterns, result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(
                result.alerts.some(function (a) {
                  return a.alertType === "UNUSUAL_LOCATION";
                }),
              ).toBe(true);
              return [2 /*return*/];
          }
    ...
    it("should flag unusual device", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var currentTransaction, historicalPatterns, result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(
                result.alerts.some(function (a) {
                  return a.alertType === "UNUSUAL_DEVICE";
                }),
              ).toBe(true);
              return [2 /*return*/];
          }
    ...
    it("should monitor round number transactions", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(
                result.alerts.some(function (a) {
                  return a.alertType === "ROUND_AMOUNT";
                }),
              ).toBe(true);
              return [2 /*return*/];
          }
    ...
    it("should block high velocity transactions", function () {
      return __awaiter(void 0, void 0, void 0, function () {
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              console.log(
                ...
                result.alerts.map(function (a) {
                  return { type: a.alertType, action: a.action };
                }),
              );
              console.log(
                "Historical patterns count:",
              ...
              expect(
                result.alerts.some(function (a) {
                  return a.alertType === "HIGH_VELOCITY";
                }),
              ).toBe(true);
              expect(
                result.alerts.some(function (a) {
    ...
    it("should block high value from new account", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var currentTransaction, result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(
                result.alerts.some(function (a) {
                  return a.alertType === "NEW_ACCOUNT_HIGH_VALUE";
                }),
              ).toBe(true);
              expect(
                result.alerts.some(function (a) {
    ...
    it("should flag suspicious merchant", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var currentTransaction, result;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(
                result.alerts.some(function (a) {
                  return a.alertType === "SUSPICIOUS_MERCHANT";
                }),
              ).toBe(true);
              return [2 /*return*/];
          }
    ...
    it("should block potential account takeover", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var currentTransaction, historicalPatterns, result;
        return __generator(this, function (_a) {
          switch (_a.label) {
  ...
  describe("Fraud Rule Management", function () {
    it("should allow adding custom rules", function () {
      ...
      expect(
        activeRules.some(function (r) {
          return r.id === "CUSTOM_RULE";
        }),
      ).toBe(true);
    });
...
describe("Fraud Monitoring Service", function () {
  ...
  describe("recordAlert", function () {
    it("should record fraud alert", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var alert, alerts;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fraud_detector_1.FraudMonitoringService.recordAlert(alert),
              ];
            case 1:
              _a.sent();
    ...
    it("should trigger critical alert handling", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var criticalAlert;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fraud_detector_1.FraudMonitoringService.recordAlert(
                  criticalAlert,
                ),
              ];
            case 1:
  ...
  describe("getAlertsForUser", function () {
    it("should return alerts for specific user", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fraud_detector_1.FraudMonitoringService.recordAlert(alert1),
              ];
            case 1:
              _a.sent();
              return [
                4 /*yield*/,
                fraud_detector_1.FraudMonitoringService.recordAlert(alert2),
              ];
            case 2:
              _a.sent();
              user1Alerts =
                fraud_detector_1.FraudMonitoringService.getAlertsForUser(
                  "user1",
                );
    ...
    it("should limit number of alerts returned", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                fraud_detector_1.FraudMonitoringService.recordAlert(alert_1),
              ];
            case 2:
              _a.sent();
              _a.label = 3;
            case 3:
              ...
              return [3 /*break*/, 1];
            case 4:
              alerts = fraud_detector_1.FraudMonitoringService.getAlertsForUser(
                "user1",
                5,
              );
  ...
  describe("getAlertsBySeverity", function () {
    it("should return alerts by severity", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                fraud_detector_1.FraudMonitoringService.recordAlert(highAlert),
              ];
            case 1:
              _a.sent();
              return [
            ...
            case 2:
              _a.sent();
              highAlerts =
                fraud_detector_1.FraudMonitoringService.getAlertsBySeverity(
                  "high",
                );
