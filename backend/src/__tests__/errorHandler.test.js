...
jest.mock('../utils/logger.js', function () { return ({
    logger: mockLogger,
}); });
...
(0, globals_1.describe)('Error Handler Middleware', function () {
    ...
    (0, globals_1.describe)('errorHandler', function () {
        (0, globals_1.it)('should handle ApiError correctly', function () {
            ...
            (0, errorHandler_js_1.errorHandler)(error, mockRequest, mockResponse, nextFunction);
        ...
        (0, globals_1.it)('should handle Zod validation errors correctly', function () {
        ...
        (0, globals_1.it)('should log errors', function () {
            var error = new Error('Test error');
            (0, errorHandler_js_1.errorHandler)(error, mockRequest, mockResponse, nextFunction);
            (0, globals_1.expect)(mockLogger.error).toHaveBeenCalledWith("".concat(error.statusCode || 500, " - ").concat(error.message, " - ").concat(mockRequest.originalUrl, " - ").concat(mockRequest.method, " - ").concat(mockRequest.ip));
        });
    });
