...
describe('MailService Integration Tests', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, util_1.promisify)(fs.mkdir)(templatesDir, { recursive: true })];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
                    testTemplateContent = "\n        <!DOCTYPE html>\n        <html>\n        <head>\n            <title>{{title}}</title>\n        </head>\n        <body>\n            <h1>{{header}}</h1>\n            <p>Hello {{name}},</p>\n            <p>{{message}}</p>\n            {{#if buttonText}}\n            <a href=\"{{buttonUrl}}\">{{buttonText}}</a>\n            {{/if}}\n            <p>\u00A9 {{year}} AccuBooks</p>\n        </body>\n        </html>\n      ";
                    return [4 /*yield*/, (0, util_1.promisify)(fs.writeFile)(path.join(templatesDir, "".concat(testTemplate, ".hbs")), testTemplateContent, 'utf8')];
                case 4:
                    _a.sent();
    ...
    describe('sendMail', function () {
        it('should send an email with template successfully', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        // Act
                        return [4 /*yield*/, mailService.sendMail(testRecipient, testSubject, testTemplate, testContext)];
                    case 1:
                        // Act
                        _a.sent();
        ...
        it('should throw an error for invalid template', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // Act & Assert
                    return [4 /*yield*/, expect(mailService.sendMail('test@example.com', 'Test Email', 'non-existent-template', testContext)).rejects.toThrow()];
                    case 1:
                        // Act & Assert
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('should handle template compilation errors', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        templatesDir = path.join(__dirname, '../../../mail/templates');
                        return [4 /*yield*/, (0, util_1.promisify)(fs.writeFile)(path.join(templatesDir, "".concat(badTemplate, ".hbs")), '{{#each invalid}}', // Invalid handlebars syntax
                            'utf8')];
                    case 1:
                        _a.sent();
                        // Act & Assert
                        return [4 /*yield*/, expect(mailService.sendMail('test@example.com', 'Test Email', badTemplate, testContext)).rejects.toThrow()];
                    case 2:
                        // Act & Assert
                        _a.sent();
                        return [2 /*return*/];
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var templatesDir, testTemplatePath, badTemplatePath, files, error_2, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 13, , 14]);
                    templatesDir = path.join(__dirname, '../../../mail/templates');
                    testTemplatePath = path.join(templatesDir, "".concat(testTemplate, ".hbs"));
                    badTemplatePath = path.join(templatesDir, 'bad-template.hbs');
                    if (!fs.existsSync(testTemplatePath)) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, util_1.promisify)(fs.unlink)(testTemplatePath).catch(console.error)];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
                    if (!fs.existsSync(badTemplatePath)) return [3 /*break*/, 4];
                    return [4 /*yield*/, (0, util_1.promisify)(fs.unlink)(badTemplatePath).catch(console.error)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
                    _a.trys.push([4, 8, , 9]);
                    return [4 /*yield*/, (0, util_1.promisify)(fs.readdir)(templatesDir)];
                case 5:
                    files = _a.sent();
                    if (!(files.length === 0)) return [3 /*break*/, 7];
                    return [4 /*yield*/, (0, util_1.promisify)(fs.rmdir)(templatesDir).catch(console.error)];
                case 6:
                    _a.sent();
                    _a.label = 7;
