...
globals_1.jest.mock("../../utils/prisma.js", function () {
  return {
    prisma: mockPrisma,
  };
});
// Mock the generateInvoiceNumber method
var mockGenerateInvoiceNumber = globals_1.jest
  .fn()
  ...
  return {
    InvoiceService: globals_1.jest.fn().mockImplementation(function () {
      return __assign(
        __assign(
          {},
          globals_1.jest.requireActual("../../services/invoice.service.js")
...
(0, globals_1.describe)("InvoiceService Integration Tests", function () {
  ...
  (0, globals_1.beforeEach)(function () {
    ...
    mockPrisma.$transaction.mockImplementation(function (callback) {
  ...
  (0, globals_1.describe)("createInvoice", function () {
    (0, globals_1.it)("should create a new invoice with items", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var generateInvoiceNumberSpy,
          invoiceData,
          result,
          items,
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              generateInvoiceNumberSpy = globals_1.jest
                .spyOn(
                  invoice_service_js_1.InvoiceService.prototype,
            ...
            case 1:
              ...
              ((items = invoiceData.items),
                (invoiceDataWithoutItems = __rest(invoiceData, ["items"])));
              (0, globals_1.expect)(
                mockPrisma.invoice.create,
              ).toHaveBeenCalledWith({
                data: __assign(__assign({}, invoiceDataWithoutItems), {
                  invoiceNumber: "INV-001",
                }),
              });
              // Verify items were created
              (0, globals_1.expect)(
                mockPrisma.invoiceItem.createMany,
              ).toHaveBeenCalledWith({
                data: [
                  {
                    description: "Test Item 1",
  ...
  (0, globals_1.describe)("updateInvoice", function () {
    (0, globals_1.it)("should update an existing invoice", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              _a.trys.push([0, 2, , 3]);
              updatedInvoice = __assign(__assign({}, mockInvoice), {
                status: "SENT",
              ...
              return [
                4 /*yield*/,
                invoiceService.updateInvoice("1", updateData),
              ];
            case 1:
              result = _a.sent();
              ...
              // Verify the result
              (0, globals_1.expect)(result).toEqual(
                __assign(__assign({}, updatedInvoice), {
                  items: mockInvoiceItems,
                }),
              );
              return [3 /*break*/, 3];
    ...
    (0, globals_1.it)(
      "should throw an error if invoice not found",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          var error_3, error_4;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  (0, globals_1.expect)(
                    invoiceService.updateInvoice("nonexistent-id", {
                      status: "SENT",
                    }),
                  ).rejects.toThrow(errors_js_1.ApiError),
                ];
              case 1:
                // Test and verify
                _a.sent();
              ...
              case 4:
                error_3 = _a.sent();
                (0, globals_1.expect)(error_3).toBeInstanceOf(
                  errors_js_1.ApiError,
                );
                (0, globals_1.expect)(error_3.statusCode).toBe(404);
                (0, globals_1.expect)(error_3.message).toBe(
                  "Invoice not found",
                );
                return [3 /*break*/, 5];
              case 5:
  ...
  (0, globals_1.describe)("deleteInvoice", function () {
    (0, globals_1.it)("should delete an invoice and its items", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var error_5;
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              (0, globals_1.expect)(
                mockPrisma.invoiceItem.deleteMany,
              ).toHaveBeenCalledWith({
                where: { invoiceId: "1" },
              });
              // Verify the invoice was deleted
              (0, globals_1.expect)(
                mockPrisma.invoice.delete,
              ).toHaveBeenCalledWith({
                where: { id: "1" },
              });
              return [3 /*break*/, 3];
        ...
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              ...
              case 4:
                error_6 = _a.sent();
                (0, globals_1.expect)(error_6).toBeInstanceOf(
                  errors_js_1.ApiError,
                );
                (0, globals_1.expect)(error_6.statusCode).toBe(404);
                (0, globals_1.expect)(error_6.message).toBe(
                  "Invoice not found",
                );
                return [3 /*break*/, 5];
              case 5:
  ...
  (0, globals_1.describe)("getInvoiceById", function () {
    (0, globals_1.it)("should return an invoice with items", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var result, error_8;
        return __generator(this, function (_a) {
          switch (_a.label) {
  ...
  (0, globals_1.describe)("getInvoicesByCompany", function () {
    (0, globals_1.it)(
      "should return paginated invoices for a company",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  invoiceService.getInvoicesByCompany("company-123", 1, 10),
                ];
              case 1:
                result = _a.sent();
                // Verify the query
