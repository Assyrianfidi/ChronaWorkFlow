...
jest.mock('../../services/invoice.service.js', () => {
  return {
    InvoiceService: jest.fn().mockImplementation(() => {
      return {
        ...jest.requireActual('../../services/invoice.service.js').InvoiceService.prototype,
  ...
  describe('createInvoice', () => {
    it('should create a new invoice with items', async () => {
      try {
        ...
        // Mock the generateInvoiceNumber method
        const generateInvoiceNumberSpy = jest.spyOn(InvoiceService.prototype as any, 'generateInvoiceNumber')
  ...
  describe('updateInvoice', () => {
    ...
    it('should throw an error if invoice not found', async () => {
      try {
        ...
        try {
          await invoiceService.updateInvoice('nonexistent-id', { status: 'SENT' });
        } catch (error) {
  ...
  describe('getInvoicesByCompany', () => {
    it('should return paginated invoices for a company', async () => {
      try {
        ...
        const result = await invoiceService.getInvoicesByCompany('company-123', 1, 10);
