...
(0, globals_1.describe)('RefreshTokenService - Unit Tests', function () {
    ...
    (0, globals_1.describe)('generateRefreshToken', function () {
        ...
        (0, globals_1.it)('should generate tokens with only hex characters', function () {
            var token = refreshToken_service_js_1.RefreshTokenService.generateRefreshToken();
    ...
    (0, globals_1.describe)('Token Security', function () {
        ...
        (0, globals_1.it)('should generate cryptographically secure tokens', function () {
            // Generate many tokens and check for uniqueness
            var tokens = new Set();
            for (var i = 0; i < 1000; i++) {
                tokens.add(refreshToken_service_js_1.RefreshTokenService.generateRefreshToken());
            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, globals_1.expect)(refreshToken_service_js_1.RefreshTokenService.createRefreshToken(1)).rejects.toThrow('Failed to create refresh token')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
