...
jest.mock("../utils/prisma.js", function () {
  return {
    prisma: {
      user: {
        findUnique: jest.fn(),
...
describe("AuthService", function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(bcryptjs_1.default.hash).toHaveBeenCalledWith(
                userData.password,
                10,
              );
              ...
              ((password = mockUser.password),
                (expectedUser = __rest(mockUser, ["password"])));
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              expect(bcryptjs_1.default.compare).toHaveBeenCalledWith(
              ...
              ((password = mockUser.password),
                (userWithoutPassword = __rest(mockUser, ["password"])));
  ...
  describe("getCurrentUser", function () {
    ...
    it("should throw an error if user is not found", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        var userId;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                expect(authService.getCurrentUser(userId)).rejects.toThrow(
                  "User not found",
                ),
              ];
            case 1:
