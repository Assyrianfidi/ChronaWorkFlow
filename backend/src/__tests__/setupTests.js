...
(0, globals_1.afterEach)(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            return [4 /*yield*/, prisma_1.prisma.$executeRaw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["TRUNCATE TABLE \"ReconciliationReport\" CASCADE;"], ["TRUNCATE TABLE \\\"ReconciliationReport\\\" CASCADE;"])))];
            case 1:
                // Clean database between tests
                _a.sent();
                return [2 /*return*/];
