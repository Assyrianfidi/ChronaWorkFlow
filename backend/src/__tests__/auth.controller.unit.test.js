...
jest.mock('../middleware/errorHandler.js', function () { return ({}); });
(0, globals_1.describe)('Auth Controller - Unit Tests', function () {
    var login, register, refreshToken, logout, logoutAll, changePassword;
    var mockRequest;
    var mockResponse;
    var nextFunction;
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var authControllerModule;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('../controllers/auth.controller.js'); })];
                case 1:
                    authControllerModule = _a.sent();
                    (login = authControllerModule.login, register = authControllerModule.register, refreshToken = authControllerModule.refreshToken, logout = authControllerModule.logout, logoutAll = authControllerModule.logoutAll, changePassword = authControllerModule.changePassword);
                    return [2 /*return*/];
            }
        });
    }); });
    ...
    (0, globals_1.describe)('login', function () {
        (0, globals_1.it)('should login user and set refresh token cookie', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockUser, mockTokens, mockRefreshToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        (0, globals_1.it)('should handle login failure', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockRequest.body = {
    ...
    (0, globals_1.describe)('register', function () {
        (0, globals_1.it)('should register new user and set refresh token cookie', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockUser, mockTokens, mockRefreshToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('refreshToken', function () {
        (0, globals_1.it)('should refresh access token with valid refresh token', function () { return __awaiter(void 0, void 0, void 0, function () {
            var mockRefreshToken, mockNewRefreshToken, mockUser, mockTokens;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(mockRefreshTokenService.verifyRefreshToken).toHaveBeenCalledWith(mockNewRefreshToken);
                        (0, globals_1.expect)(mockAuthService.generateAccessToken).toHaveBeenCalledWith(mockUser);
                        (0, globals_1.expect)(mockResponse.cookie).toHaveBeenCalledWith('refreshToken', mockNewRefreshToken, globals_1.expect.any(Object));
                        (0, globals_1.expect)(mockResponse.status).toHaveBeenCalledWith(http_status_codes_1.StatusCodes.OK);
                        (0, globals_1.expect)(mockResponse.json).toHaveBeenCalledWith({
                            success: true,
                            data: {
                        ...
                        (0, globals_1.expect)(mockLogger.info).toHaveBeenCalledWith('Token refreshed for user: test@example.com (ID: 1) from IP: 127.0.0.1');
                        return [2 /*return*/];
                }
            });
        }); });
        ...
        (0, globals_1.it)('should handle refresh token failure and clear cookie', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        (0, globals_1.expect)(mockLogger.error).toHaveBeenCalledWith('Token refresh failed from IP: 127.0.0.1');
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('logout', function () {
        (0, globals_1.it)('should logout user and clear refresh token', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        (0, globals_1.it)('should handle logout without refresh token', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockRequest.cookies = {};
                    ...
                    case 1:
                        _a.sent();
                        (0, globals_1.expect)(mockRefreshTokenService.invalidateRefreshToken).not.toHaveBeenCalled();
                        (0, globals_1.expect)(mockResponse.clearCookie).toHaveBeenCalled();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    (0, globals_1.describe)('logoutAll', function () {
        (0, globals_1.it)('should logout user from all sessions', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    (0, globals_1.describe)('changePassword', function () {
        (0, globals_1.it)('should change password and invalidate all refresh tokens', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockRequest.user = { id: 1, role: 'USER' };
        ...
        (0, globals_1.it)('should validate password format', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        mockRequest.user = { id: 1, role: 'USER' };
