...
var mockRefreshTokenService = {
  ...
  getRefreshTokenExpiry: jest.fn(function () {
    return 30;
  }),
};
var mockLogger = {
...
jest.mock("../services/auth.service", function () {
  return {
    authService: mockAuthService,
  };
});
jest.mock("../services/refreshToken.service.ts", function () {
  return {
...
jest.mock("../middleware/errorHandler.js", function () {
  return {};
});
(0, globals_1.describe)("Auth Controller - Unit Tests", function () {
          ...
          case 0:
            return [
              ...
              Promise.resolve().then(function () {
                return require("../controllers/auth.controller.js");
              }),
            ];
          case 1:
            authControllerModule = _a.sent();
            ((login = authControllerModule.login),
              (register = authControllerModule.register),
              (refreshToken = authControllerModule.refreshToken),
              (logout = authControllerModule.logout),
              (logoutAll = authControllerModule.logoutAll),
              (changePassword = authControllerModule.changePassword));
            return [2 /*return*/];
        }
      });
    });
  ...
  (0, globals_1.describe)("login", function () {
    (0, globals_1.it)(
      "should login user and set refresh token cookie",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  login(mockRequest, mockResponse, nextFunction),
                ];
              case 1:
                _a.sent();
                (0, globals_1.expect)(
                ...
                (0, globals_1.expect)(
                  mockRefreshTokenService.createRefreshToken,
                ).toHaveBeenCalledWith(1);
                (0, globals_1.expect)(mockResponse.cookie).toHaveBeenCalledWith(
                  "refreshToken",
                  mockRefreshToken,
                ...
                (0, globals_1.expect)(mockResponse.status).toHaveBeenCalledWith(
                ...
                (0, globals_1.expect)(mockLogger.info).toHaveBeenCalledWith(
    ...
    (0, globals_1.it)("should handle login failure", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
  ...
  (0, globals_1.describe)("register", function () {
    (0, globals_1.it)(
      "should register new user and set refresh token cookie",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          var mockUser, mockTokens, mockRefreshToken;
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  register(mockRequest, mockResponse, nextFunction),
                ];
              case 1:
                _a.sent();
                (0, globals_1.expect)(
  ...
  (0, globals_1.describe)("refreshToken", function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  refreshToken(mockRequest, mockResponse, nextFunction),
                ];
              case 1:
                _a.sent();
                (0, globals_1.expect)(
                  mockRefreshTokenService.rotateRefreshToken,
                ).toHaveBeenCalledWith(mockRefreshToken);
                (0, globals_1.expect)(
                  mockRefreshTokenService.verifyRefreshToken,
                ).toHaveBeenCalledWith(mockNewRefreshToken);
                (0, globals_1.expect)(
                  mockAuthService.generateAccessToken,
    ...
    (0, globals_1.it)("should reject missing refresh token", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
    ...
    (0, globals_1.it)(
      "should handle refresh token failure and clear cookie",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
  ...
  (0, globals_1.describe)("logout", function () {
    (0, globals_1.it)(
      "should logout user and clear refresh token",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  logout(mockRequest, mockResponse, nextFunction),
                ];
              case 1:
                _a.sent();
                (0, globals_1.expect)(
  ...
  (0, globals_1.describe)("logoutAll", function () {
    (0, globals_1.it)("should logout user from all sessions", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                logoutAll(mockRequest, mockResponse, nextFunction),
              ];
            case 1:
              _a.sent();
              (0, globals_1.expect)(
    ...
    (0, globals_1.it)("should require authentication", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
  ...
  (0, globals_1.describe)("changePassword", function () {
    (0, globals_1.it)(
      "should change password and invalidate all refresh tokens",
      function () {
        return __awaiter(void 0, void 0, void 0, function () {
          return __generator(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [
                  4 /*yield*/,
                  changePassword(mockRequest, mockResponse, nextFunction),
                ];
              case 1:
                _a.sent();
                (0, globals_1.expect)(
                  mockAuthService.changePassword,
                ).toHaveBeenCalledWith(1, "oldpassword", "newpassword123");
                (0, globals_1.expect)(
                  mockRefreshTokenService.invalidateUserRefreshTokens,
                ).toHaveBeenCalledWith(1);
                (0, globals_1.expect)(
    ...
    (0, globals_1.it)("should validate password format", function () {
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
