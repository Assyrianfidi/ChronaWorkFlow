...
exports.config = {
    ...
    database: {
        url: process.env.DATABASE_URL || 'postgresql://user:password@localhost:5432/accu_books',
    ...
    upload: {
        ...
        allowedTypes: ((_b = process.env.ALLOWED_FILE_TYPES) === null || _b === void 0 ? void 0 : _b.split(',')) || ['image/jpeg', 'image/png', 'application/pdf'],
