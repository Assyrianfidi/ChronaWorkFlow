...
var handlePrismaError = function (err) {
  ...
  if (err.code === "P2002") {
    var field =
      ((_b = (_a = err.meta) === null || _a === void 0 ? void 0 : _a.target) ===
        null || _b === void 0
        ? void 0
        : _b[0]) || "field";
    return new AppError(
      "Duplicate ".concat(field, " value. Please use another value."),
      400,
    );
  }
  if (err.code === "P2025") {
...
var globalErrorHandler = function (err, req, res, next) {
  ...
  if (error.name === "JsonWebTokenError") error = (0, exports.handleJWTError)();
    ...
    .json(
      __assign(
        __assign(
          ...
          !config_1.config.isProduction && { stack: error.stack },
        ),
