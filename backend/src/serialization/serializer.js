...
var Serializer = /** @class */ (function () {
  ...
  Serializer.prototype.serialize = function (type, data, options) {
    ...
    if (Array.isArray(data)) {
      return data.map(function (item) {
        return _this.serialize(type, item, options);
      });
    }
    // Handle objects
  ...
  Serializer.prototype.serializeObject = function (obj, options) {
    var serialized = {};
    var _a = options.exclude,
      exclude = _a === void 0 ? [] : _a,
    ...
    for (var _i = 0, _c = Object.entries(obj); _i < _c.length; _i++) {
      ...
      serialized[key] = this.serializeValue(
        value,
        __assign(__assign({}, options), { depth: depth + 1 }),
      );
    }
  ...
  Serializer.prototype.serializeValue = function (value, options) {
    ...
    if (Array.isArray(value)) {
      return value.map(function (item) {
        return _this.serializeValue(item, options);
      });
    }
  ...
  Serializer.prototype.deserialize = function (type, data) {
    ...
    if (Array.isArray(data)) {
      return data.map(function (item) {
        return _this.deserialize(type, item);
      });
    }
    // Handle objects
    if (typeof data === "object" && data !== null) {
  ...
  Serializer.prototype.deserializeValue = function (value) {
    ...
    if (Array.isArray(value)) {
      return value.map(function (item) {
        return _this.deserializeValue(item);
      });
    }
    if (typeof value === "object") {
      // Handle date strings
