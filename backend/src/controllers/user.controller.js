...
exports.deleteMe = exports.updateMe = exports.deleteUser = exports.updateUser = exports.createUser = exports.getUser = exports.getAllUsers = void 0;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                userId = parseInt(id);
                if (isNaN(userId)) {
                    throw new errorHandler_js_1.ApiError('Invalid user ID', 400, errorHandler_js_1.ErrorCodes.VALIDATION_ERROR);
                }
            ...
            case 1:
                user = _b.sent();
                if (!user) {
                    throw new errorHandler_js_1.ApiError('User not found', 404, errorHandler_js_1.ErrorCodes.NOT_FOUND);
                }
...
var createUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, email, password, _b, role, existingUser, salt, hashedPassword, user, error_3;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                _a = req.body, name_1 = _a.name, email = _a.email, password = _a.password, _b = _a.role, role = _b === void 0 ? client_1.Role.USER : _b;
                // Basic validation
            ...
            case 1:
                ...
                if (existingUser) {
                    throw new errorHandler_js_1.ApiError('User already exists', 400, errorHandler_js_1.ErrorCodes.CONFLICT);
                }
...
var updateUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, userId, _a, name_2, email, role, isActive, existingUser, updateData, emailExists, user, error_4;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                id = req.params.id;
                userId = parseInt(id);
                _a = req.body, name_2 = _a.name, email = _a.email, role = _a.role, isActive = _a.isActive;
                if (isNaN(userId)) {
                    throw new errorHandler_js_1.ApiError('Invalid user ID', 400, errorHandler_js_1.ErrorCodes.VALIDATION_ERROR);
                }
            ...
            case 2:
                ...
                if (emailExists && emailExists.id !== userId) {
                    throw new errorHandler_js_1.ApiError('Email already taken', 400, errorHandler_js_1.ErrorCodes.CONFLICT);
                }
        ...
        switch (_b.label) {
            case 0:
                ...
                if (userId === req.user.id) {
                    throw new errorHandler_js_1.ApiError('Cannot delete your own account', 400, errorHandler_js_1.ErrorCodes.VALIDATION_ERROR);
                }
                return [4 /*yield*/, prisma.user.findUnique({
                        where: { id: userId },
                    })];
...
var deleteMe = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var error_7;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
