...
exports.healthCheck = exports.getTransactionHistory = exports.convertCurrency = exports.calculateLoanDetails = exports.getAccountSummary = exports.processTransaction = void 0;
 ...
 */
var processTransaction = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, _a, fromAccountId, toAccountId, amount, currency, description, reference, metadata, context, result, error_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = req.body, fromAccountId = _a.fromAccountId, toAccountId = _a.toAccountId, amount = _a.amount, currency = _a.currency, description = _a.description, reference = _a.reference, metadata = _a.metadata;
                context = {
                    ipAddress: req.ip,
                    device: req.headers['user-agent'],
                    location: req.headers['x-location'],
                    merchantCategory: metadata === null || metadata === void 0 ? void 0 : metadata.merchantCategory
                };
                return [4 /*yield*/, business_logic_service_1.businessLogicService.processTransaction({
...
var getAccountSummary = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, business_logic_service_1.businessLogicService.getAccountSummary(accountId, userId)];
            case 1:
                summary = _b.sent();
...
var calculateLoanDetails = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _d.trys.push([0, 2, , 3]);
                _a = req.body, principal = _a.principal, annualRate = _a.annualRate, months = _a.months;
                return [4 /*yield*/, business_logic_service_1.businessLogicService.calculateLoanDetails(principal, annualRate, months)];
            case 1:
                loanDetails = _d.sent();
...
var convertCurrency = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _d.trys.push([0, 2, , 3]);
                _a = req.body, amount = _a.amount, fromCurrency = _a.fromCurrency, toCurrency = _a.toCurrency;
                return [4 /*yield*/, business_logic_service_1.businessLogicService.convertCurrency(amount, fromCurrency, toCurrency)];
            case 1:
                conversion = _d.sent();
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                return [4 /*yield*/, business_logic_service_1.businessLogicService.getTransactionHistory(userId, accountId, Number(limit), Number(offset))];
            case 1:
                history_1 = _e.sent();
...
var healthCheck = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, business_logic_service_1.businessLogicService.healthCheck()];
            case 1:
                health = _a.sent();
                res.json({
                    success: true,
