...
exports.getReportStats = exports.deleteReport = exports.updateReport = exports.createReport = exports.getReport = exports.getAllReports = void 0;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                if (!req.user) {
                    throw new errorHandler_js_1.ApiError('Not authenticated', 401, errorHandler_js_1.ErrorCodes.UNAUTHORIZED);
                }
                queryObj_1 = __assign({}, req.query);
                excludedFields = ['page', 'sort', 'limit', 'fields'];
                excludedFields.forEach(function (el) { return delete queryObj_1[el]; });
                ...
                if (req.user.role !== client_1.Role.ADMIN) {
                    query.where = __assign(__assign({}, query.where), { userId: req.user.id });
                }
                return [4 /*yield*/, prisma.reconciliationReport.findMany(__assign(__assign({}, query), { include: {
                            user: {
                                select: {
                                    id: true,
                                    name: true,
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (isNaN(reportId)) {
                    throw new errorHandler_js_1.ApiError('Invalid report ID', 400, errorHandler_js_1.ErrorCodes.VALIDATION_ERROR);
                }
                return [4 /*yield*/, prisma.reconciliationReport.findUnique({
                        where: { id: reportId },
                        include: {
                            user: {
                                select: {
            ...
            case 1:
                report = _b.sent();
                if (!report) {
                    throw new errorHandler_js_1.ApiError('Report not found', 404, errorHandler_js_1.ErrorCodes.NOT_FOUND);
                }
                // Check if user owns the report or is admin
                if (report.userId !== req.user.id && req.user.role !== client_1.Role.ADMIN) {
                    throw new errorHandler_js_1.ApiError('Access denied', 403, errorHandler_js_1.ErrorCodes.FORBIDDEN);
                }
        ...
        switch (_c.label) {
            case 0:
                ...
                if (!title || amount === undefined) {
                    throw new errorHandler_js_1.ApiError('Missing required fields', 400, errorHandler_js_1.ErrorCodes.VALIDATION_ERROR);
                }
                return [4 /*yield*/, prisma.reconciliationReport.create({
                        data: {
                            title: title,
...
var updateReport = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, reportId, _a, title, amount, existingReport, updateData, report, error_4;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
            ...
            case 1:
                ...
                if (existingReport.userId !== req.user.id && req.user.role !== client_1.Role.ADMIN) {
                    throw new errorHandler_js_1.ApiError('Access denied', 403, errorHandler_js_1.ErrorCodes.FORBIDDEN);
                }
                updateData = {};
                if (title !== undefined)
                ...
                return [4 /*yield*/, prisma.reconciliationReport.update({
                        where: { id: reportId },
                        data: updateData,
                    })];
            case 2:
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.reconciliationReport.delete({
                        where: { id: reportId },
                    })];
            case 2:
                _b.sent();
...
var getReportStats = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var stats, error_6;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma.reconciliationReport.groupBy({
                        by: ['title'],
                        _count: {
                            id: true,
                        },
                        ...
                        where: req.user.role === client_1.Role.ADMIN ? {} : { userId: req.user.id },
                    })];
            case 1:
                stats = _b.sent();
