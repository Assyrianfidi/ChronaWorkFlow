        ...
        return __generator(this, function (_e) {
          switch (_e.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                cacheEngine_js_1.CacheEngine.checkRateLimit(
                  identifier,
                  limit.requests,
                  limit.window,
                ),
            ...
            case 2:
              ...
              throw new errorHandler_js_1.ApiError(
                "Rate limit exceeded for "
                  .concat(category, ". Try again in ")
                  .concat(
                    Math.ceil((result.resetTime - Date.now()) / 1000),
                    " seconds.",
                  ),
                429,
                errorHandler_js_1.ErrorCodes.RATE_LIMIT_EXCEEDED,
              );
            case 3:
              next();
              return [2 /*return*/];
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                cacheEngine_js_1.CacheEngine.exists(cooldownKey),
              ];
            case 1:
              inCooldown = _d.sent();
              if (inCooldown) {
                throw new errorHandler_js_1.ApiError(
                  ...
                  429,
                  errorHandler_js_1.ErrorCodes.TOO_MANY_REQUESTS,
                );
              }
            ...
            case 2:
              ...
              return [
                4 /*yield*/,
                cacheEngine_js_1.CacheEngine.set(burstKey, burstCount, 10),
              ];
            case 3:
            ...
            case 4:
              ...
              return [
                4 /*yield*/,
                cacheEngine_js_1.CacheEngine.set(
                  cooldownKey,
                  true,
                  cooldownSeconds,
                ),
            ...
            case 7:
              _d.sent();
              throw new errorHandler_js_1.ApiError(
                "Burst limit exceeded. Cooldown activated for ".concat(
                  cooldownSeconds,
                  " seconds.",
                ),
                429,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              cacheEngine_js_1.CacheEngine.get(reputationKey),
            ];
          case 1:
            reputation = _a.sent();
            if (reputation) return [2 /*return*/, reputation];
            // Default to medium for unknown IPs
            return [
              4 /*yield*/,
              cacheEngine_js_1.CacheEngine.set(reputationKey, "medium", 3600),
            ];
          case 2:
            // Default to medium for unknown IPs
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!result.allowed) {
                throw new errorHandler_js_1.ApiError(
                  "Rate limit exceeded for ".concat(tier, " tier"),
                  429,
                  errorHandler_js_1.ErrorCodes.RATE_LIMIT_EXCEEDED,
                );
              }
