  ...
  CacheEngine.get = function (key) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!this.isConnected) return [2 /*return*/, null];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
  ...
  CacheEngine.set = function (key_1, value_1) {
    return __awaiter(this, arguments, void 0, function (key, value, ttl) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!this.isConnected) return [2 /*return*/];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
            return [
  ...
  CacheEngine.incr = function (key) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!this.isConnected) return [2 /*return*/, 0];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
  ...
  CacheEngine.exists = function (key) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!this.isConnected) return [2 /*return*/, false];
            _a.label = 1;
          case 1:
            _a.trys.push([1, 3, , 4]);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              CacheEngine.delPattern("user:".concat(userId, ":*")),
            ];
          case 1:
            _a.sent();
            return [
              4 /*yield*/,
              CacheEngine.delPattern("transactions:user:".concat(userId, ":*")),
            ];
          case 2:
            _a.sent();
            return [
              4 /*yield*/,
              CacheEngine.delPattern("balances:user:".concat(userId, ":*")),
            ];
          case 3:
            _a.sent();
            return [2 /*return*/];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              CacheEngine.delPattern("account:".concat(accountId, ":*")),
            ];
          case 1:
            _a.sent();
            return [
              4 /*yield*/,
              CacheEngine.delPattern(
                "balances:account:".concat(accountId, ":*"),
              ),
            ];
          case 2:
            _a.sent();
            return [
              4 /*yield*/,
              CacheEngine.delPattern(
                "transactions:account:".concat(accountId, ":*"),
              ),
            ];
          case 3:
            _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              CacheEngine.del("transaction:".concat(transactionId)),
            ];
          case 1:
            _a.sent();
            return [
              4 /*yield*/,
              CacheEngine.delPattern(
                "transactions:*:".concat(transactionId, ":*"),
              ),
            ];
          case 2:
            _a.sent();
  ...
  CacheInvalidator.invalidateFinancialData = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, CacheEngine.delPattern("balances:*")];
          case 1:
            _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            requests = _a.sent() || [];
            validRequests = requests.filter(function (timestamp) {
