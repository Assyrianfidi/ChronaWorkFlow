...
exports.sendPartial = exports.sendNoContent = exports.sendCreated = exports.sendPaginatedResponse = exports.sendSuccess = void 0;
/**
...
var sendSuccess = function (res, data, statusCode, meta) {
    ...
    if ((meta === null || meta === void 0 ? void 0 : meta.warnings) && meta.warnings.length > 0) {
 ...
 */
var sendPaginatedResponse = function (res, data, page, limit, total, requestId) {
...
var sendPartial = function (res, data, requestId, warnings) {
    return (0, exports.sendSuccess)(res, data, 206, { requestId: requestId, warnings: warnings });
};
