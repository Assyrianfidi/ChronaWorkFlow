...
exports.DatabaseMonitor = exports.LoadTester = exports.PerformanceMonitor = void 0;
    ...
    PerformanceMonitor.monitorCache = function (operation, key, operationFn) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endTimer = this.startTimer("cache_".concat(operation), { key: key });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
...
var LoadTester = /** @class */ (function () {
    ...
    LoadTester.runConcurrentRequests = function (url, options) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, promises, responseTimes, statusCodes, errorCount, successCount, i, requestPromise, totalTime, avgResponseTime, minResponseTime, maxResponseTime;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        startTime = Date.now();
                    ...
                    case 1:
                        ...
                        if (!(promises.length >= options.concurrency)) return [3 /*break*/, 3];
                        return [4 /*yield*/, Promise.all(promises.splice(0, options.concurrency))];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
                        if (!(options.delay && options.delay > 0)) return [3 /*break*/, 5];
                        return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, options.delay); })];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5:
                    ...
                    case 7:
                        ...
                        avgResponseTime = responseTimes.length > 0
                            ...
                            : 0;
                        minResponseTime = responseTimes.length > 0 ? Math.min.apply(Math, responseTimes) : 0;
                        maxResponseTime = responseTimes.length > 0 ? Math.max.apply(Math, responseTimes) : 0;
                        return [2 /*return*/, {
                                totalTime: totalTime,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, { statusCode: response.status, duration: duration }];
                    case 3:
                        error_3 = _a.sent();
                        duration = Date.now() - startTime;
                        throw new Error("Request failed after ".concat(duration, "ms: ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(concurrency <= options.maxConcurrency)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.runConcurrentRequests(url, {
...
var DatabaseMonitor = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _e.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, prisma.$queryRaw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT \n        COUNT(*) as total,\n        SUM(CASE WHEN state = 'active' THEN 1 ELSE 0 END) as active,\n        SUM(CASE WHEN state = 'idle' THEN 1 ELSE 0 END) as idle,\n        SUM(CASE WHEN waiting = true THEN 1 ELSE 0 END) as waiting\n        FROM pg_stat_activity WHERE datname = current_database()"], ["SELECT \n        COUNT(*) as total,\n        SUM(CASE WHEN state = 'active' THEN 1 ELSE 0 END) as active,\n        SUM(CASE WHEN state = 'idle' THEN 1 ELSE 0 END) as idle,\n        SUM(CASE WHEN waiting = true THEN 1 ELSE 0 END) as waiting\n        FROM pg_stat_activity WHERE datname = current_database()"])))];
                    case 1:
                        stats = _e.sent();
                        return [2 /*return*/, {
                                totalConnections: ((_a = stats[0]) === null || _a === void 0 ? void 0 : _a.total) || 0,
                                activeConnections: ((_b = stats[0]) === null || _b === void 0 ? void 0 : _b.active) || 0,
                                idleConnections: ((_c = stats[0]) === null || _c === void 0 ? void 0 : _c.idle) || 0,
                                waitingClients: ((_d = stats[0]) === null || _d === void 0 ? void 0 : _d.waiting) || 0
                            }];
                    case 2:
                        error_4 = _e.sent();
                        logger_js_1.logger.info({
    ...
    DatabaseMonitor.getSlowQueries = function (prisma_1) {
        return __awaiter(this, arguments, void 0, function (prisma, thresholdMs) {
            ...
            if (thresholdMs === void 0) { thresholdMs = 1000; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
