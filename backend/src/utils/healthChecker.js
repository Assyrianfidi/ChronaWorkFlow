            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        allHealthy = Object.values(results).every(function (r) { return r.status === 'healthy'; });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        start = Date.now();
                        return [4 /*yield*/, server_js_1.prisma.$queryRaw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["SELECT 1"], ["SELECT 1"])))];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, cacheEngine_js_1.CacheEngine.set('health:check', 'ok', 10)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, cacheEngine_js_1.CacheEngine.get('health:check')];
                    case 2:
                        value = _a.sent();
                        if (value === 'ok') {
                            ...
                            return [2 /*return*/, { status: 'unhealthy', error: 'Cache value mismatch' }];
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        error_3 = _a.sent();
    ...
    HealthChecker.checkMemory = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, {
                        status: status,
                        usage: __assign(__assign({}, usage), { usagePercent: memoryUsagePercent }),
                    }];
            });
        });
    };
    ...
    MetricsCollector.getMetrics = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.allSettled([
                            performanceMonitor_js_1.DatabaseMonitor.getConnectionPoolStats(server_js_1.prisma),
                            Promise.resolve(circuitBreaker_js_1.CircuitBreakerRegistry.getAllStatuses()),
                            Promise.resolve(HealthChecker.checkMemory()),
                        ])];
                    case 1:
                        _a = _b.sent(), dbStats = _a[0], circuitBreakerStats = _a[1], memoryStats = _a[2];
                        return [2 /*return*/, {
                                timestamp: new Date().toISOString(),
                                uptime: process.uptime(),
    ...
    MetricsCollector.prometheusMetrics = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    case 0: return [4 /*yield*/, this.getMetrics()];
                    case 1:
                        metrics = _o.sent();
                        prometheusMetrics = [
                            ...
                            "accu_books_memory_usage_bytes{type=\"rss\"} ".concat(((_b = (_a = metrics.memory) === null || _a === void 0 ? void 0 : _a.usage) === null || _b === void 0 ? void 0 : _b.rss) || 0),
                            "accu_books_memory_usage_bytes{type=\"heapTotal\"} ".concat(((_d = (_c = metrics.memory) === null || _c === void 0 ? void 0 : _c.usage) === null || _d === void 0 ? void 0 : _d.heapTotal) || 0),
                            "accu_books_memory_usage_bytes{type=\"heapUsed\"} ".concat(((_f = (_e = metrics.memory) === null || _e === void 0 ? void 0 : _e.usage) === null || _f === void 0 ? void 0 : _f.heapUsed) || 0),
                            "accu_books_memory_usage_bytes{type=\"external\"} ".concat(((_h = (_g = metrics.memory) === null || _g === void 0 ? void 0 : _g.usage) === null || _h === void 0 ? void 0 : _h.external) || 0),
                            '',
                            "# HELP accu_books_db_connections Database connection pool stats",
                            "# TYPE accu_books_db_connections gauge",
                            "accu_books_db_connections{state=\"total\"} ".concat(((_j = metrics.database) === null || _j === void 0 ? void 0 : _j.totalConnections) || 0),
                            "accu_books_db_connections{state=\"active\"} ".concat(((_k = metrics.database) === null || _k === void 0 ? void 0 : _k.activeConnections) || 0),
                            "accu_books_db_connections{state=\"idle\"} ".concat(((_l = metrics.database) === null || _l === void 0 ? void 0 : _l.idleConnections) || 0),
                            "accu_books_db_connections{state=\"waiting\"} ".concat(((_m = metrics.database) === null || _m === void 0 ? void 0 : _m.waitingClients) || 0),
                        ].join('\n');
