...
var QueryOptimizer = /** @class */ (function () {
    ...
    QueryOptimizer.batchFetchTransactions = function (transactionIds_1) {
        return __awaiter(this, arguments, void 0, function (transactionIds, includeRelations) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3: return [4 /*yield*/, this.prisma.transaction.findMany({
                            where: { id: { in: transactionIds } }
                        })];
                    case 4:
                        transactions = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.prisma.transactionLine.groupBy({
                                by: ['accountId'],
                                where: {
    ...
    QueryOptimizer.getTransactionsPaginated = function (companyId_1) {
        return __awaiter(this, arguments, void 0, function (companyId, page, limit, filters) {
            var startTime, skip, whereClause, _a, transactions, total, duration, error_3;
    ...
    QueryOptimizer.processTransactionBatch = function (transactions_1) {
        return __awaiter(this, arguments, void 0, function (transactions, batchSize) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.prisma.$transaction(batch.map(function (tx) {
