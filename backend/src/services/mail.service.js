...
var MailService = /** @class */ (function () {
    ...
    MailService.prototype.compileTemplate = function (templateName, data) {
        var templatePath = path.join(__dirname, '..', 'templates', "".concat(templateName, ".hbs"));
        var templateSource = fs.readFileSync(templatePath, 'utf8');
        var template = handlebars.compile(templateSource);
        return template(data);
    };
    MailService.prototype.sendMail = function (to, subject, templateName, context) {
