...
exports.authService = exports.AuthService = exports.generateAccessToken = exports.UserRole = void 0;
...
var generateAccessToken = function (user) {
    var _a;
    if (!((_a = config_js_1.config.jwt) === null || _a === void 0 ? void 0 : _a.secret)) {
    ...
    var accessToken = jsonwebtoken_1.default.sign({
        ...
        role: user.role,
        type: 'access'
    }, config_js_1.config.jwt.secret, { expiresIn: ACCESS_TOKEN_EXPIRES_IN });
    return {
...
var generateRefreshToken = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
    var token, expiresAt;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!((_a = config_js_1.config.jwt) === null || _a === void 0 ? void 0 : _a.refreshSecret)) {
                    throw new Error('JWT refresh secret is not configured');
                }
                token = jsonwebtoken_1.default.sign({
                    userId: userId,
                    type: 'refresh'
                }, config_js_1.config.jwt.refreshSecret, { expiresIn: REFRESH_TOKEN_EXPIRES_IN });
                expiresAt = new Date();
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.register = function (userData) {
        return __awaiter(this, void 0, void 0, function () {
            var existingUser, salt, hashedPassword, user, tokens, password, userWithoutPassword;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (existingUser) {
                            throw new errors_js_1.ApiError(http_status_codes_1.StatusCodes.BAD_REQUEST, 'Email is already registered');
                        }
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, { user: userWithoutPassword, tokens: tokens }];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!user || !user.isActive) {
                            throw new errors_js_1.ApiError(http_status_codes_1.StatusCodes.UNAUTHORIZED, 'Invalid email or password');
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), accessTokenResult = _a[0], refreshToken = _a[1];
                        return [2 /*return*/, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 6, , 9]);
                        decoded = jsonwebtoken_1.default.verify(refreshToken, config_js_1.config.jwt.refreshSecret);
                        if (decoded.type !== 'refresh') {
                            throw new Error('Invalid token type');
                        }
                        return [4 /*yield*/, prisma.refreshToken.findFirst({
                                where: {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, prisma.refreshToken.delete({
                    ...
                    case 6:
                        error_1 = _b.sent();
                        if (!(error_1 instanceof jsonwebtoken_1.default.TokenExpiredError)) return [3 /*break*/, 8];
                    ...
                    case 7:
                        // Clean up expired token
                        _b.sent();
                        throw new errors_js_1.ApiError(http_status_codes_1.StatusCodes.UNAUTHORIZED, 'Refresh token expired');
                    case 8: throw new errors_js_1.ApiError(http_status_codes_1.StatusCodes.UNAUTHORIZED, 'Invalid refresh token');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            throw new errors_js_1.ApiError(http_status_codes_1.StatusCodes.NOT_FOUND, 'User not found');
                        }
                        return [4 /*yield*/, bcryptjs_1.default.compare(currentPassword, user.password)];
                    case 2:
                        isPasswordValid = _a.sent();
                        if (!isPasswordValid) {
                            throw new errors_js_1.ApiError(http_status_codes_1.StatusCodes.UNAUTHORIZED, 'Current password is incorrect');
                        }
                        return [4 /*yield*/, bcryptjs_1.default.genSalt(10)];
                    case 3:
                        salt = _a.sent();
