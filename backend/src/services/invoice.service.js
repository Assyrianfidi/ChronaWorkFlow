...
var InvoiceService = /** @class */ (function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                                ...
                                prisma_js_1.prisma.invoice.count({ where: { companyId: companyId } }),
                            ])];
                    case 1:
    ...
    InvoiceService.prototype.getInvoiceById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma_js_1.prisma.invoice.findUnique({
                            where: { id: id },
                        })];
                    case 1:
                        invoice = _a.sent();
                        ...
                        return [4 /*yield*/, prisma_js_1.prisma.invoiceItem.findMany({
                                where: { invoiceId: id },
                            })];
                    case 2:
                        items = _a.sent();
                        return [2 /*return*/, __assign(__assign({}, invoice), { items: items })];
                }
            });
        });
    };
                        ...
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                case 0:
                                    ...
                                    _c = {};
                                    _d = {};
                                    return [4 /*yield*/, this.generateInvoiceNumber(invoiceData.companyId)];
                                case 1: return [4 /*yield*/, _b.apply(_a, [(_c.data = (_d.invoiceNumber = _e.sent(),
                                ...
                                case 2:
                                    ...
                                    return [4 /*yield*/, tx.invoiceItem.createMany({
                                ...
                                case 3:
                                    _e.sent();
                                    _e.label = 4;
                                case 4: return [4 /*yield*/, tx.invoiceItem.findMany({
                                        where: { invoiceId: invoice.id },
                                    })];
                                case 5:
                                    invoiceItems = _e.sent();
                                    return [2 /*return*/, __assign(__assign({}, invoice), { items: invoiceItems })];
                            }
                        });
                    }); })];
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma_js_1.prisma.invoice.update({
                                where: { id: id },
                    ...
                    case 3:
                        items = _a.sent();
                        return [2 /*return*/, __assign(__assign({}, updatedInvoice), { items: items })];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, prisma_js_1.prisma.invoiceItem.deleteMany({
                                where: { invoiceId: id },
                            })];
                    case 2:
                        // Delete invoice items first (due to foreign key constraint)
                        _a.sent();
                        // Delete the invoice
                        return [4 /*yield*/, prisma_js_1.prisma.invoice.delete({
                                where: { id: id },
                            })];
                    case 3:
                        // Delete the invoice
    ...
    InvoiceService.prototype.generateInvoiceNumber = function (companyId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma_js_1.prisma.invoice.count({
                            where: { companyId: companyId },
                        })];
                    case 1:
                        count = _a.sent();
                        // Generate a unique invoice number (e.g., INV-0001, INV-0002, etc.)
                        return [2 /*return*/, "INV-".concat(String(count + 1).padStart(4, '0'))];
                }
            });
        });
    };
