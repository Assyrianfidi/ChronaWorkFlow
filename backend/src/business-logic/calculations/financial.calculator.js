...
var FinancialCalculator = /** @class */ (function () {
  ...
  FinancialCalculator.prototype.calculateCompoundInterest = function (
    principal,
    rate,
    time,
    compoundsPerYear,
  ) {
    if (compoundsPerYear === void 0) {
      compoundsPerYear = 1;
    }
    return (
  ...
  FinancialCalculator.prototype.calculateLoanPayment = function (
    principal,
    annualRate,
    years,
  ) {
  ...
  FinancialCalculator.prototype.calculateDepreciation = function (
    cost,
    salvage,
    usefulLife,
  ) {
