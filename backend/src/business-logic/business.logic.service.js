...
var BusinessLogicService = /** @class */ (function () {
  function BusinessLogicService() {
    ...
    this.circuitBreaker = circuitBreaker_1.CircuitBreakerRegistry.get(
      "business-logic",
      {
        failureThreshold: 5,
        resetTimeout: 60000,
   ...
   */
  BusinessLogicService.prototype.processTransaction = function (
    request,
    userId,
    context,
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
                  ...
                  return __generator(this, function (_a) {
                    return [
                      ...
                      this.prisma.account.findMany({
                        where: {
                          id: {
                            in: [request.fromAccountId, request.toAccountId],
                          },
          ...
          case 1:
            ...
            fromAccount = accounts.find(function (a) {
              return a.id === request.fromAccountId;
            });
            toAccount = accounts.find(function (a) {
              return a.id === request.toAccountId;
            });
            balanceValidation =
              domain_validator_1.DomainValidator.validateBalance(
                fromAccount.balance,
                request.amount,
                fromAccount.type,
                fromAccount.allowOverdraft || false,
              );
            domain_validator_1.DomainValidator.validateOrThrow(
              balanceValidation,
            );
            ...
            return [
              4 /*yield*/,
              this.getExchangeRate(fromAccount.currency, toAccount.currency),
            ];
          case 2:
            exchangeRate = _a.sent();
            domain_validator_1.ValidationRules.internationalTransfer(
          ...
          case 3:
            return [
              4 /*yield*/,
              this.getTransactionPatterns(userId, fromAccount.id),
            ];
          case 4:
          ...
          case 5:
            ...
            feeAmount = this.calculateTransactionFee(
              request.amount,
              fromAccount.type,
            );
            mainTransaction = {
          ...
          case 7:
            ...
            throw new errorHandler_1.ApiError(
              ...
              500,
              errorHandler_1.ErrorCodes.INTERNAL_ERROR,
            );
          case 8:
            return [2 /*return*/];
        }
   ...
   */
  BusinessLogicService.prototype.getAccountSummary = function (
    accountId,
    userId,
  ) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            throw new errorHandler_1.ApiError(
              ...
              500,
              errorHandler_1.ErrorCodes.DATABASE_ERROR,
            );
          case 4:
            return [2 /*return*/];
        }
   ...
   */
  BusinessLogicService.prototype.calculateLoanDetails = function (
    principal,
    annualRate,
    months,
  ) {
   ...
   */
  BusinessLogicService.prototype.convertCurrency = function (
    amount,
    fromCurrency,
    toCurrency,
  ) {
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            throw new errorHandler_1.ApiError(
              ...
              500,
              errorHandler_1.ErrorCodes.EXTERNAL_SERVICE_ERROR,
            );
          case 3:
            return [2 /*return*/];
        }
   ...
   */
  BusinessLogicService.prototype.getTransactionHistory = function (
    userId_1,
    accountId_1,
  ) {
    return __awaiter(
      ...
      arguments,
      void 0,
      function (userId, accountId, limit, offset) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.getFraudAlertsForTransactions(transactionIds),
              ];
            case 2:
              fraudAlerts = _a.sent();
   ...
   * Helper methods
   */
  BusinessLogicService.prototype.getExchangeRate = function (
    fromCurrency,
    toCurrency,
  ) {
    return __awaiter(this, void 0, void 0, function () {
  ...
  BusinessLogicService.prototype.calculateTransactionFee = function (
    amount,
    accountType,
  ) {
    ...
    var feeStructure = feeStructures[accountType] || feeStructures["CHECKING"];
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        for (
          ...
          if (
            !bookkeeping_rules_1.BookkeepingRules.validateTransaction(
              transaction,
            )
          ) {
            throw new errorHandler_1.ApiError(
  ...
  BusinessLogicService.prototype.getTransactionPatterns = function (
    userId,
    accountId,
  ) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            return [
              ...
              transactions.map(function (t) {
                ...
                return {
                  ...
                  location:
                    (_a = t.metadata) === null || _a === void 0
                      ? void 0
                      : _a.location,
                  device:
                    (_b = t.metadata) === null || _b === void 0
                      ? void 0
                      : _b.device,
                  ipAddress:
                    (_c = t.metadata) === null || _c === void 0
                      ? void 0
                      : _c.ipAddress,
                  merchantCategory:
                    (_d = t.metadata) === null || _d === void 0
                      ? void 0
                      : _d.merchantCategory,
                };
              }),
  ...
  BusinessLogicService.prototype.getFraudAlertsForTransactions = function (
    transactionIds,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        ...
        switch (_a.label) {
          ...
          case 4:
            return [
              ...
              {
                status:
                  dbHealthy && circuitBreakerState === "CLOSED"
                    ? "healthy"
                    : "degraded",
