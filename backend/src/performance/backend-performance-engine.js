...
var BackendPerformanceEngine = /** @class */ (function () {
    function BackendPerformanceEngine() {
        ...
        this.logger = logger_js_1.logger.child({ component: 'BackendPerformanceEngine' });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_1 = _a.sent();
                        this.logger.error('Failed to setup database optimizations:', error_1);
                        return [3 /*break*/, 5];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.prisma.$executeRaw(templateObject_1 || (templateObject_1 = __makeTemplateObject(["", ""], ["", ""])), indexSql)];
                    case 3:
                        _a.sent();
                    ...
                    case 4:
                        error_2 = _a.sent();
                        this.logger.warn("Failed to create index: ".concat(indexSql), error_2);
                        return [3 /*break*/, 5];
                    case 5:
                        _i++;
                        return [3 /*break*/, 1];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, this.analyzeSlowQueries()];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
    ...
    BackendPerformanceEngine.prototype.startMonitoring = function () {
        ...
        this.monitoringInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.processMetrics()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BackendPerformanceEngine.prototype.startReportGeneration = function () {
        var _this = this;
        this.reportInterval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.generatePeriodicReports()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BackendPerformanceEngine.prototype.checkThresholds = function (metrics) {
        ...
        if (metrics.duration > threshold.maxDuration * (threshold.alertThreshold / 100)) {
            alerts.push({
                ...
                message: "Response time ".concat(metrics.duration, "ms exceeds threshold of ").concat(threshold.maxDuration, "ms"),
                metrics: metrics,
                threshold: threshold,
        ...
        if (metrics.memoryUsage > threshold.maxMemory * (threshold.alertThreshold / 100)) {
            alerts.push({
                ...
                endpoint: metrics.endpoint,
                message: "Memory usage ".concat(metrics.memoryUsage, "MB exceeds threshold of ").concat(threshold.maxMemory, "MB"),
                metrics: metrics,
                threshold: threshold,
                triggeredAt: new Date(),
                status: 'open'
        ...
        if (metrics.dbQueries > threshold.maxQueries * (threshold.alertThreshold / 100)) {
            alerts.push({
                ...
                endpoint: metrics.endpoint,
                message: "Database queries ".concat(metrics.dbQueries, " exceeds threshold of ").concat(threshold.maxQueries),
                metrics: metrics,
                threshold: threshold,
                triggeredAt: new Date(),
                status: 'open'
        ...
        if (totalRequests > 0) {
            ...
            if (missRate > threshold.maxCacheMissRate * (threshold.alertThreshold / 100)) {
                alerts.push({
                    ...
                    endpoint: metrics.endpoint,
                    message: "Cache miss rate ".concat(missRate.toFixed(2), "% exceeds threshold of ").concat(threshold.maxCacheMissRate, "%"),
                    metrics: metrics,
                    threshold: threshold,
                    triggeredAt: new Date(),
                    status: 'open'
     ...
     */
    BackendPerformanceEngine.prototype.calculateSeverity = function (actual, threshold) {
     ...
     */
    BackendPerformanceEngine.prototype.updatePerformanceAggregations = function (metrics) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        _a.optimizedQuery = _b.sent(),
                            _a.improvement = 0,
                            _a.recommendations = this.generateQueryRecommendations(queryData.query);
                        return [4 /*yield*/, this.suggestIndexes(queryData.query)];
                    case 2:
                        optimization = (_a.indexes = _b.sent(),
                            _a.analyzedAt = new Date(),
                            _a);
     ...
     */
    BackendPerformanceEngine.prototype.generateOptimizedQuery = function (originalQuery) {
        return __awaiter(this, void 0, void 0, function () {
            var optimized;
            return __generator(this, function (_a) {
     ...
     */
    BackendPerformanceEngine.prototype.generateQueryRecommendations = function (query) {
        var recommendations = [];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.sent();
                        now = new Date();
                        if (!(now.getHours() === 0 && now.getMinutes() < 5)) return [3 /*break*/, 3];
    ...
    BackendPerformanceEngine.prototype.generateReport = function (period) {
        return __awaiter(this, void 0, void 0, function () {
            var endTime, startTime, metrics, summary, slowestEndpoints, databaseMetrics, cacheMetrics, alerts, recommendations, report;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        endTime = new Date();
                        startTime = this.getReportStartTime(endTime, period);
                        metrics = this.metrics.filter(function (m) { return m.timestamp >= startTime && m.timestamp <= endTime; });
     ...
     */
    BackendPerformanceEngine.prototype.getReportStartTime = function (endTime, period) {
    ...
    BackendPerformanceEngine.prototype.calculateSummary = function (metrics) {
        ...
        var averageResponseTime = durations.reduce(function (sum, d) { return sum + d; }, 0) / totalRequests;
        var p95ResponseTime = durations[Math.floor(totalRequests * 0.95)];
        var p99ResponseTime = durations[Math.floor(totalRequests * 0.99)];
        var errorCount = metrics.filter(function (m) { return m.statusCode >= 400; }).length;
        var errorRate = (errorCount / totalRequests) * 100;
        var totalCacheHits = metrics.reduce(function (sum, m) { return sum + m.cacheHits; }, 0);
        var totalCacheRequests = metrics.reduce(function (sum, m) { return sum + m.cacheHits + m.cacheMisses; }, 0);
        var cacheHitRate = totalCacheRequests > 0 ? (totalCacheHits / totalCacheRequests) * 100 : 0;
        var timeSpan = (metrics[metrics.length - 1].timestamp.getTime() - metrics[0].timestamp.getTime()) / 1000;
     ...
     */
    BackendPerformanceEngine.prototype.getSlowestEndpoints = function (startTime, endTime) {
        return __awaiter(this, void 0, void 0, function () {
            var aggregations, endpointGroups, _i, _a, _b, endpoint, data;
            return __generator(this, function (_c) {
                aggregations = [];
                endpointGroups = this.metrics
                    .filter(function (m) { return m.timestamp >= startTime && m.timestamp <= endTime; })
                ...
                for (_i = 0, _a = Object.entries(endpointGroups); _i < _a.length; _i++) {
                ...
                return [2 /*return*/, aggregations.map(function (agg) { return ({
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        pool = poolStats;
                        return [2 /*return*/, {
                                averageQueryTime: ((_a = stats[0]) === null || _a === void 0 ? void 0 : _a.avg_query_time) || 0,
                                slowQueries: ((_b = stats[0]) === null || _b === void 0 ? void 0 : _b.total_queries) || 0,
                                connectionPool: {
                                    active: ((_c = pool[0]) === null || _c === void 0 ? void 0 : _c.active) || 0,
                                    idle: ((_d = pool[0]) === null || _d === void 0 ? void 0 : _d.idle) || 0,
                                    total: ((_e = pool[0]) === null || _e === void 0 ? void 0 : _e.total) || 0
                                }
                            }];
                    case 3:
                        error_5 = _f.sent();
     ...
     */
    BackendPerformanceEngine.prototype.generateRecommendations = function (summary, alerts) {
        var recommendations = [];
        ...
        if (alerts.some(function (a) { return a.type === 'slow_query'; })) {
            recommendations.push('Slow queries detected. Review database indexes and query optimization.');
        }
        if (alerts.some(function (a) { return a.type === 'memory_leak'; })) {
    ...
    BackendPerformanceEngine.prototype.getPerformanceAlerts = function (status) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, alerts.sort(function (a, b) { return b.triggeredAt.getTime() - a.triggeredAt.getTime(); })];
            });
        });
    };
    /**
     * Acknowledge alert
     */
    BackendPerformanceEngine.prototype.acknowledgeAlert = function (alertId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            return __generator(this, function (_a) {
                alert = this.performanceAlerts.find(function (a) { return a.id === alertId; });
                if (!alert) {
     ...
     * Resolve alert
     */
    BackendPerformanceEngine.prototype.resolveAlert = function (alertId, resolution, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            return __generator(this, function (_a) {
                alert = this.performanceAlerts.find(function (a) { return a.id === alertId; });
    ...
    BackendPerformanceEngine.prototype.getRealTimeMetrics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var now, oneMinuteAgo, recentMetrics, currentRPS, averageResponseTime, memoryUsage, cacheStats, cacheHitRate, activeConnections;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        now = Date.now();
                        oneMinuteAgo = now - 60000;
                        recentMetrics = this.metrics.filter(function (m) { return m.timestamp.getTime() >= oneMinuteAgo; });
                        currentRPS = recentMetrics.length / 60;
                        averageResponseTime = recentMetrics.length > 0
                            ? recentMetrics.reduce(function (sum, m) { return sum + m.duration; }, 0) / recentMetrics.length
                            : 0;
    ...
    BackendPerformanceEngine.prototype.optimizeCacheConfiguration = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0: return [4 /*yield*/, this.getRealTimeMetrics()];
                    case 1:
