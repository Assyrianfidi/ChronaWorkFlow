...
app.use(
  (0, cors_1.default)({
    ...
    allowedHeaders: __spreadArray(
      [],
      config_js_1.config.security.cors.allowedHeaders,
      true,
    ),
  }),
);
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            healthChecker_js_1.HealthChecker.detailedHealth(req, res),
          ];
        case 1:
          _a.sent();
          return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            healthChecker_js_1.HealthChecker.readiness(req, res),
          ];
        case 1:
          _a.sent();
          return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            healthChecker_js_1.HealthChecker.liveness(req, res),
          ];
        case 1:
          _a.sent();
          return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            healthChecker_js_1.MetricsCollector.prometheusMetrics(req, res),
          ];
        case 1:
          _a.sent();
          return [2 /*return*/];
...
app.use(
  "/api/auth",
  rateLimiter_js_1.RateLimiter.perUserLimit("auth"),
  auth_routes_js_1.default,
);
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          server = app.listen(PORT_1, function () {
            console.log(
              "Server running in "
                .concat(process.env.NODE_ENV || "development", " mode on port ")
                .concat(PORT_1),
            );
          });
