...
exports.userRoleMappings =
  exports.userRoles =
  exports.notifications =
  exports.userPreferences =
  exports.auditLogs =
  exports.reconciliationReports =
...
exports.reconciliationReports = (0, pg_core_1.pgTable)(
...
// User Preferences
exports.userPreferences = (0, pg_core_1.pgTable)(
  "user_preferences",
  {
    id: (0, pg_core_1.serial)("id").primaryKey(),
    userId: (0, pg_core_1.integer)("userId")
  ...
  function (table) {
    return {
      userIdUnique: (0, pg_core_1.unique)("user_preferences_user_id_unique").on(
        table.userId,
      ),
    };
  },
...
exports.userRoleMappings = (0, pg_core_1.pgTable)(
  "user_role_mappings",
  {
    userId: (0, pg_core_1.integer)("userId")
      .notNull()
