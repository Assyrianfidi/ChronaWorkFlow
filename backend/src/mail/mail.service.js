...
var MailService = function () {
    ...
    var MailService = _classThis = /** @class */ (function () {
        ...
        MailService_1.prototype.compileTemplate = function (templateName, context) {
            var filePath = path_1.default.join(__dirname, 'templates', templateName + '.hbs');
            var source = fs_1.default.readFileSync(filePath, 'utf8');
            var template = handlebars_1.default.compile(source);
            return template(context);
        };
        MailService_1.prototype.sendMail = function (to, subject, template, context) {
