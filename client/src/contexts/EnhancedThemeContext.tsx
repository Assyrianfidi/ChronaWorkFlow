...
import { ThemeMode, ThemeName, ThemeConfig, themes, getTheme, getThemeColors } from '@/config/themes';
...
export function EnhancedThemeProvider({ children }: EnhancedThemeProviderProps) {
  ...
  useEffect(() => {
    ...
    root.style.setProperty('--font-family-heading', themeConfig.typography.fontFamilyHeading);
