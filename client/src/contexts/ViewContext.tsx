...
export function ViewProvider({
  ...
  const setSpecializedView = useCallback(
    (view: SpecializedViewMode) => {
      if (!canAccessView(view, userRole, userTier, enabledFeatures)) {
  ...
  const setMultiCompanyView = useCallback(
    (view: MultiCompanyViewMode) => {
      if (!canAccessView(view, userRole, userTier, enabledFeatures)) {
  ...
  const canAccessViewCheck = useCallback(
    (viewId: string) => {
