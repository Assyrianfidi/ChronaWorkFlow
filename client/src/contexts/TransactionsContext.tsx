...
const TransactionsContext = createContext<{
  ...
  createTransaction: (transactionData: Omit<Transaction, 'id' | 'createdBy' | 'createdAt' | 'updatedAt'> & { lines: TransactionLine[] }) => Promise<void>;
  clearError: () => void;
...
export const TransactionsProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Create transaction
  const createTransaction = async (transactionData: Omit<Transaction, 'id' | 'createdBy' | 'createdAt' | 'updatedAt'> & { lines: TransactionLine[] }): Promise<void> => {
    try {
      dispatch({ type: 'SET_LOADING', payload: true });
