...
export default function Customers() {
  ...
  const customersWithBalances: CustomerWithBalance[] = customers.map(
    (customer) => {
  ...
  const avgBalance =
    customersWithBalances.length > 0
      ? totalReceivables / customersWithBalances.length
      : 0;
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <div
                className="text-2xl font-semibold tabular-nums text-chart-2"
                  ...
                  {filteredCustomers.map((customer) => (
                    ...
                    >
                      ...
                      <TableCell className="text-right">
                        <div
                          className={`font-semibold tabular-nums ${customer.balance > 0 ? "text-chart-2" : customer.balance < 0 ? "text-destructive" : "text-muted-foreground"}`}
                        >
