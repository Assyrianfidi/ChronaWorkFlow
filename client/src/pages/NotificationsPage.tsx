...
interface Notification {
  ...
  read: boolean
  createdAt: string
  category: 'SYSTEM' | 'INVOICE' | 'CUSTOMER' | 'PAYMENT' | 'SECURITY' | 'REPORT'
  actionUrl?: string
...
const mockNotifications: Notification[] = [
  {
    ...
    message: 'Invoice INV-003 has been successfully created for Tech Solutions Ltd with amount $3,200.00',
    read: false,
  ...
  },
  {
    ...
    message: 'Invoice INV-002 for ABC Corporation is overdue by 10 days. Total amount: $2,500.00',
    read: false,
  ...
  },
  {
    ...
    message: 'Payment for invoice INV-005 could not be processed due to invalid payment method. Please update customer payment information.',
    read: false,
  ...
  },
  {
    ...
    message: 'Scheduled system maintenance will occur on December 15, 2024 from 2:00 AM to 4:00 AM EST. Services may be temporarily unavailable.',
    read: true,
  ...
  },
  {
    ...
    message: 'New customer Global Marketing Inc has been successfully registered and added to the system.',
    read: true,
  ...
  },
  {
    ...
    message: 'Multiple failed login attempts detected from IP address 203.45.67.89. Please review security logs.',
    read: false,
  ...
  },
  {
    ...
    message: 'November 2024 financial report has been generated and is ready for review. Total revenue: $45,200.00',
    read: true,
  ...
  },
  {
    ...
    message: 'Payment of $1,800.50 has been received for invoice INV-004 from XYZ Industries.',
    read: true,
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {emailNotifications ? <Volume2 className="w-4 h-4" /> : <VolumeX className="w-4 h-4" />}
                <Switch
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {pushNotifications ? <Volume2 className="w-4 h-4" /> : <VolumeX className="w-4 h-4" />}
                <Switch
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3 flex-1">
                        <div className={`p-2 rounded-full ${typeConfig[notification.type].color}`}>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className={`text-sm mb-2 ${!notification.read ? 'text-blue-800' : 'text-gray-600'}`}>
