...
// @ts-ignore
import { useVendors, type Vendor } from '../hooks/use-api.js.js';
// @ts-ignore
...
export default function Vendors() {
  ...
  const totalPayables = vendors.reduce(
    (sum: number, vendor: Vendor) => sum + parseFloat(vendor.balance),
    0,
  );
  const activeVendors = vendors.filter(
    (vendor: Vendor) => vendor.isActive,
  ).length;
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <div
                ...
                data-testid="text-total-payables"
              >
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <div
                className="text-2xl font-semibold"
                data-testid="text-active-vendors"
              >
                {activeVendors}
              </div>
            </CardHeader>
