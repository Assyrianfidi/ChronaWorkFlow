...
const QuickStat: React.FC<QuickStatProps> = ({ icon: Icon, label, value, change, color }) => {
  const colorClasses = {
  ...
  return (
    <div className="financial-card p-6">
      ...
      <p className="text-3xl font-extrabold text-gray-900" style={{ fontFamily: 'var(--font-heading)' }}>
        {value}
      </p>
    </div>
  );
...
export const FinancialDashboard: React.FC = () => {
  ...
  const quickStats = [
    { icon: DollarSign, label: 'Total Revenue', value: '$124.5K', change: 12.5, color: 'green' as const },
    { icon: TrendingUp, label: 'Net Profit', value: '$37.3K', change: 18.7, color: 'blue' as const },
    { icon: Users, label: 'Active Clients', value: '89', change: 4.2, color: 'purple' as const },
    { icon: Activity, label: 'Cash Flow', value: '$45.2K', change: 8.3, color: 'orange' as const },
  ];
      ...
      >
          ...
          <div className="px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-6">
                <div>
                  <h1 className="text-3xl font-extrabold text-gray-900 mb-1" style={{ fontFamily: 'var(--font-heading)' }}>
                    Financial Dashboard
                  </h1>
                ...
                >
                  ...
                  <span className="text-sm font-bold text-gray-700">{selectedPeriod}</span>
        ...
        <main id="main-content" className="p-8">
          ...
          <section aria-labelledby="financial-widgets-heading" className="mb-8">
            <h2 id="financial-widgets-heading" className="sr-only">Financial Widgets</h2>
          ...
          <section aria-labelledby="insights-heading" className="mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 id="insights-heading" className="text-2xl font-extrabold text-gray-900" style={{ fontFamily: 'var(--font-heading)' }}>
                Business Insights
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="financial-card">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  <div>
                    ...
                    <p className="text-xl font-extrabold text-gray-900" style={{ fontFamily: 'var(--font-heading)' }}>
                      $42.3K
                    </p>
                  </div>
              ...
              <div className="financial-card">
                ...
                <div className="space-y-4">
                  {[
                    { category: 'Payroll', amount: 45678, percentage: 52, color: 'bg-blue-500' },
                    { category: 'Office Rent', amount: 12000, percentage: 14, color: 'bg-purple-500' },
                    { category: 'Software & Tools', amount: 8900, percentage: 10, color: 'bg-green-500' },
                    { category: 'Marketing', amount: 7500, percentage: 9, color: 'bg-orange-500' },
                    { category: 'Other', amount: 13156, percentage: 15, color: 'bg-gray-400' },
                  ].map((expense) => (
                    <div key={expense.category}>
                      ...
                      <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          className={cn('h-full rounded-full transition-all duration-500', expense.color)}
          ...
          <footer className="mt-12 pt-8 border-t border-gray-200">
            <div className="flex items-center justify-between text-sm text-gray-500">
              ...
              <div className="flex items-center gap-6">
                <a href="#" className="hover:text-gray-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 rounded-md px-2 py-1">
                  Privacy Policy
                </a>
                <a href="#" className="hover:text-gray-700 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 rounded-md px-2 py-1">
                  Terms of Service
