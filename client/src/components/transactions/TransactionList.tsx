        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-success text-primary-foreground rounded-lg hover:bg-success/90">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-border rounded-lg bg-card text-foreground focus:ring-2 focus:ring-primary"
                />
              </div>
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <button className="p-1.5 text-muted-foreground hover:text-primary rounded hover:bg-muted">
        ...
        {selectedTransaction && (
          <div className="fixed inset-0 bg-background/80 flex items-center justify-center z-50 p-4">
            <div className="bg-card rounded-xl shadow-elevated max-w-lg w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-success text-primary-foreground rounded-lg hover:bg-success/90"
                  >
                    <Sparkles className="w-4 h-4" />
                    Re-categorize with AI
                  </button>
                  <button className="flex items-center justify-center gap-2 px-4 py-2 border border-border text-foreground rounded-lg hover:bg-muted">
                    <Edit className="w-4 h-4" />
                    Edit
                  </button>
                </div>
