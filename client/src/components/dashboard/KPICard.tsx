      ...
      >
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              {change !== undefined && (
                <div className="flex items-center gap-1">
                  ...
                  <span className={cn("text-sm font-medium", currentColor.change)}>
            ...
            {icon && (
              <div className={cn("p-3 rounded-xl bg-white/20 backdrop-blur-sm", currentColor.icon)}>
                {icon}
              </div>
            )}
          </div>
...
export const RevenueCard = ({ value, change }: { value: string | number; change?: number }) => (
  <KPICard
    title="Total Revenue"
    value={value}
    change={change}
...
export const CustomersCard = ({ value, change }: { value: string | number; change?: number }) => (
  <KPICard
...
export const InvoicesCard = ({ value, change }: { value: string | number; change?: number }) => (
  <KPICard
...
export const TransactionsCard = ({ value, change }: { value: string | number; change?: number }) => (
  <KPICard
    title="Transactions"
    value={value}
    change={change}
