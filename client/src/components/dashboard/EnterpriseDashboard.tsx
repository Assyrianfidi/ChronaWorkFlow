...
import { BarChart3, TrendingUp, Users, FileText, CreditCard, DollarSign, Settings, Bell, Search, Menu, X } from "lucide-react"
import { RevenueCard, CustomersCard, InvoicesCard, TransactionsCard } from "./KPICard"
...
const EnterpriseDashboard = React.forwardRef<HTMLDivElement, EnterpriseDashboardProps>(
  ({ className }, ref) => {
    ...
    const recentTransactions = [
      { id: "INV-001", customer: "ABC Corporation", amount: "$2,500.00", status: "Paid", date: "2024-01-15" },
      { id: "INV-002", customer: "XYZ Industries", amount: "$1,800.00", status: "Pending", date: "2024-01-14" },
      { id: "INV-003", customer: "Global Tech Ltd", amount: "$3,200.00", status: "Paid", date: "2024-01-13" },
      { id: "INV-004", customer: "StartUp Inc", amount: "$950.00", status: "Overdue", date: "2024-01-12" },
      { id: "INV-005", customer: "Enterprise Co", amount: "$5,100.00", status: "Paid", date: "2024-01-11" },
    ]
