...
import { AccessibilityProvider, useAccessibility, AccessibilityControls, AccessibilityTest } from '../AccessibilityModes';
...
describe('AccessibilityProvider', () => {
  ...
  it('applies CSS classes to document based on mode', () => {
    ...
    expect(document.documentElement.classList.add).toHaveBeenCalledWith('accessibility-high-contrast');
  });
...
describe('AccessibilityControls', () => {
  ...
  it('toggles boolean settings', async () => {
    ...
    const focusVisibleCheckbox = screen.getByText('Enhanced Focus Indicators').querySelector('input');
...
describe('AccessibilityTest', () => {
  ...
  it('triggers contrast test', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith('Contrast Test Results:', expect.any(Array));
...
describe('useAccessibility hook', () => {
  it('throws error when used outside provider', () => {
    ...
    expect(screen.getByText(/useAccessibility must be used within AccessibilityProvider/)).toBeInTheDocument();
  });

  it('returns context when used within provider', () => {
    const TestComponent = () => {
      const { config, isHighContrast, isDyslexiaFriendly, isColorblindSafe } = useAccessibility();
      return (
        <div>
          <div>Mode: {config.mode}</div>
  ...
  it('provides font size, line height, and letter spacing values', () => {
    const TestComponent = () => {
      const { currentFontSize, currentLineHeight, currentLetterSpacing } = useAccessibility();
      return (
        <div>
