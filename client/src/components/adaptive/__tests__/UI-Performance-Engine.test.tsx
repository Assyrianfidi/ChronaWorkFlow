...
import { UIPerformanceEngine, usePerformance, LazyLoad, PerformanceMonitor, withPerformanceTracking } from '../UI-Performance-Engine';
...
describe('usePerformance hook', () => {
  it('throws error when used outside provider', () => {
    ...
    expect(screen.getByText(/usePerformance must be used within UIPerformanceEngine/)).toBeInTheDocument();
  });
...
describe('withPerformanceTracking HOC', () => {
  it('wraps component with performance tracking', () => {
    ...
    const TrackedComponent = withPerformanceTracking(MockComponent, 'TestComponent');
    ...
    expect(mockContext.registerComponent).toHaveBeenCalledWith('TestComponent', expect.any(HTMLElement));
  });
  ...
  it('cleans up on unmount', () => {
    ...
    expect(mockContext.unregisterComponent).toHaveBeenCalledWith('TestComponent');
  });
});
