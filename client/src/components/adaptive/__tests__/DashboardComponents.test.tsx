...
import { InteractiveDashboard, DashboardBuilder, withPerformanceTracking } from '../DashboardComponents';
...
describe('DashboardBuilder', () => {
  ...
  it('shows empty state when no layout selected', () => {
    ...
    expect(screen.getByText(/Create a new dashboard to get started/)).toBeInTheDocument();
  });
