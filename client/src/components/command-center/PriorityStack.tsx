            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className={cn(
                  ...
                  item.priority === 'medium' ? 'bg-amber-500 text-slate-900' :
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        item.priority === 'critical' ? 'bg-rose-500/20 text-rose-400 hover:bg-rose-500/30' :
                        item.priority === 'high' ? 'bg-orange-500/20 text-orange-400 hover:bg-orange-500/30' :
                        item.priority === 'medium' ? 'bg-amber-500/20 text-amber-400 hover:bg-amber-500/30' :
