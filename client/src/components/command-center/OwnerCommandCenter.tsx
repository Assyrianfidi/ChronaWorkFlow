...
export const OwnerCommandCenter: React.FC<CommandCenterProps> = ({ className }) => {
            ...
            <div className="mb-6 flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 text-sm text-slate-500">
                ...
                {activeDepartment && (
                  <>
                    <span>/</span>
                    <span className="text-slate-300 capitalize">{activeDepartment}</span>
                  </>
                )}
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            <span className={cn(
              ...
              {data.status === 'healthy' ? 'Healthy' : 
               data.status === 'warning' ? 'Warning' : 'Needs Attention'}
            </span>
