...
import { AlertTriangle, Shield, Lock, Radio, TrendingUp, TrendingDown, Zap } from 'lucide-react';
...
const statusConfig = {
  healthy: { color: 'bg-emerald-500', glow: 'shadow-emerald-500/50', label: 'All Systems Operational' },
  warning: { color: 'bg-amber-500', glow: 'shadow-amber-500/50', label: 'Attention Required' },
  critical: { color: 'bg-rose-500', glow: 'shadow-rose-500/50', label: 'Critical Alert' },
};
    ...
    <div className="fixed top-0 left-0 right-0 z-50 h-16 bg-slate-950/90 backdrop-blur-xl border-b border-slate-800/50">
      <div className="h-full px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-1">
                <span className={cn(
                  ...
                  companyHealth >= 80 ? 'text-emerald-400' : 
                  companyHealth >= 60 ? 'text-amber-400' : 'text-rose-400'
                )}>
                  {companyHealth}
                </span>
          ...
          {/* Live Cash Position */}
          <div>
            <span className="text-xs text-slate-400 uppercase tracking-wider">Cash Position</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="text-xs text-slate-400 uppercase tracking-wider">Alerts</span>
              <p className={cn(
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-900/50 border border-slate-800">
            <Radio className={cn("w-4 h-4", status.color.replace('bg-', 'text-'))} />
