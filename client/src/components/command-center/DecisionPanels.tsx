          ...
          return (
            ...
            >
              ...
              <div className={cn(
                ...
                panel.priority === 'high' ? 'bg-rose-500' :
                panel.priority === 'medium' ? 'bg-amber-500' : 'bg-blue-500'
              )} />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <button
                    className={cn(
                      ...
                      "group-hover:gap-3",
                      panel.priority === 'high' ? 'text-rose-400 hover:text-rose-300' :
                      panel.priority === 'medium' ? 'text-amber-400 hover:text-amber-300' :
                ...
                {panel.metric && (
                  <div className="flex-shrink-0">
                    <span className={cn(
                      ...
                      panel.priority === 'high' ? 'bg-rose-500/20 text-rose-400' :
                      panel.priority === 'medium' ? 'bg-amber-500/20 text-amber-400' :
