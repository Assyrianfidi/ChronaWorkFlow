  ...
  return (
    <div className="relative w-full h-full min-h-[500px] flex items-center justify-center">
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none">
        ...
        {departments.filter(d => d.id !== 'tech').map((dept) => (
          <line
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  dept.status === 'attention' ? 'bg-indigo-500' : 'bg-emerald-500'
                )}
                style={{ 
                  width: '120px', 
                  height: '120px',
              ...
              >
                ...
                {/* Icon */}
                <div className={cn("mb-1", status.text)}>
                  {dept.icon}
                </div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-400">{dept.metricLabel}</span>
                  {dept.trend === 'up' ? (
