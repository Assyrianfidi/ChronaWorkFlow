...
describe('SmartWorkflow', () => {
  ...
  it('renders empty state when no workflow provided', () => {
    ...
    expect(screen.getByText('Create a new workflow or select an existing one')).toBeInTheDocument();
  ...
  it('displays workflow templates', () => {
    ...
    expect(screen.getByText('Document Approval')).toBeInTheDocument();
    expect(screen.getByText('Multi-level document approval workflow')).toBeInTheDocument();
    expect(screen.getByText('Incident Response')).toBeInTheDocument();
    expect(screen.getByText('Automated incident response workflow')).toBeInTheDocument();
  });
  ...
  it('updates step name in editor', async () => {
    ...
    renderWithWorkflow(mockWorkflow, { onWorkflowChange: mockOnWorkflowChange });
...
describe('SmartWorkflow Integration', () => {
  it('integrates with automation context', async () => {
    ...
    render(
      <AutomationEngine>
        <SmartWorkflow workflow={mockWorkflow} onWorkflowChange={mockOnWorkflowChange} />
      </AutomationEngine>
    );
  ...
  it('handles workflow execution through automation', async () => {
    render(
      <AutomationEngine>
        <SmartWorkflow workflow={mockWorkflow} />
      </AutomationEngine>
    );
