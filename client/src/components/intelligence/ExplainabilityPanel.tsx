        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
              ...
              <ul className="space-y-2">
                ...
                {relatedEntities.length === 0 && (
                  <li className="text-gray-600">
                    All transaction and account data
                  </li>
                )}
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600 mt-2">
                This score reflects the statistical reliability of this insight
                based on data quality, sample size, and historical patterns.
              </p>
            </div>
          </section>
          ...
          <section className="bg-gray-50 rounded-lg p-4 border border-gray-200">
            <p className="text-sm text-gray-600 text-center">
              <strong>Transparency Guarantee:</strong> This insight is based on
              rule-based analysis and statistical methods. No opaque AI or
              machine learning was used. All calculations are auditable and
              explainable.
            </p>
          </section>
        </div>
