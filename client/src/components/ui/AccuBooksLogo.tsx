  ...
  ({ className, size = "md", variant = "full", ...props }, ref) => {
    ...
    if (variant === "icon") {
      return (
        ...
        >
          ...
          <text x="48" y="28" fontFamily="Inter, sans-serif" fontSize="20" fontWeight="700" fill="#007bff">AccuBooks</text>
        </svg>
      )
    }
    ...
    return (
      ...
      >
        ...
        <text x="72" y="42" fontFamily="Inter, sans-serif" fontSize="28" fontWeight="800" fill="#007bff">AccuBooks</text>
        <text x="72" y="52" fontFamily="Inter, sans-serif" fontSize="10" fontWeight="400" fill="#6c757d">Enterprise Accounting</text>
      </svg>
    )
  }
)
