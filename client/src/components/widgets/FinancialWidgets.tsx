...
const MetricChange: React.FC<MetricChangeProps> = ({
  value,
  percentage,
    ...
    <div className={cn("financial-card", className)}>
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              {invoiceStats.total} total invoices
            </p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <div className="p-3 bg-green-50 rounded-lg border border-green-200">
          ...
          <p
            className="text-lg font-extrabold text-green-900"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            {invoiceStats.paid}
          </p>
        ...
        <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
          ...
          <p
            className="text-lg font-extrabold text-yellow-900"
            style={{ fontFamily: "var(--font-heading)" }}
          >
        ...
        <div className="p-3 bg-red-50 rounded-lg border border-red-200">
          ...
          <p
            className="text-lg font-extrabold text-red-900"
            style={{ fontFamily: "var(--font-heading)" }}
          >
