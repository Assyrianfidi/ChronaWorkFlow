...
const meta: Meta<typeof AccessibilityProvider> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Central accessibility context that manages screen reader announcements, voice commands, visual modes, and accessibility monitoring across the entire application.",
      },
    },
  },
...
export const FinancialDashboard: Story = {
    ...
    children: (
      <div style={{ padding: "2rem", maxWidth: "800px" }}>
        ...
        >
          ...
          <p>
            This content is fully accessible with screen reader support, voice
            commands, and visual adaptations.
          </p>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Financial dashboard with full accessibility integration, demonstrating how accessibility features enhance the user experience for financial applications.",
      },
    },
  },
};
