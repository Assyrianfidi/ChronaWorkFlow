...
const meta: Meta<typeof VoiceCommandEngine> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Advanced voice command engine that enables hands-free navigation and control of the application using speech recognition and natural language processing.',
      },
    },
  },
  ...
  args: {
    children: (
      <div style={{ padding: '2rem' }}>
        ...
        <p>Try saying commands like "click button", "navigate to dashboard", or "show help" to control the interface with your voice.</p>
        ...
        <div style={{ marginTop: '2rem' }}>
          ...
          <button id="voice-btn-2" style={{ marginLeft: '1rem' }}>Voice Button 2</button>
          <button id="voice-btn-3" style={{ marginLeft: '1rem' }}>Voice Button 3</button>
        </div>

        <div style={{ marginTop: '2rem' }}>
          <h2>Voice Status</h2>
          <div id="voice-status" style={{ padding: '1rem', backgroundColor: '#f0f0f0', borderRadius: '4px' }}>
            <p>Microphone: <span id="mic-status">Inactive</span></p>
      ...
      <div style={{ padding: '2rem' }}>
        ...
        <form style={{ marginTop: '2rem' }}>
          <div style={{ marginBottom: '1rem' }}>
            ...
            <input id="voice-name" type="text" placeholder="Say 'fill name John'" />
          </div>
          
          <div style={{ marginBottom: '1rem' }}>
            <label htmlFor="voice-email">Email:</label>
            <input id="voice-email" type="email" placeholder="Say 'fill email john@example.com'" />
          </div>
          
          <div style={{ marginBottom: '1rem' }}>
            <label htmlFor="voice-message">Message:</label>
            <textarea id="voice-message" placeholder="Say 'fill message Hello world'" rows={4}></textarea>
          </div>
          
          <div style={{ marginBottom: '1rem' }}>
            <label>
              <input id="voice-terms" type="checkbox" />
              I agree to the terms and conditions
            </label>
          </div>
          
          <button type="submit" id="voice-submit">Submit Form</button>
          <button type="button" id="voice-clear" style={{ marginLeft: '1rem' }}>Clear Form</button>
        </form>
      ...
      <div style={{ padding: '2rem' }}>
        ...
        <nav aria-label="Main navigation">
          <ul style={{ listStyle: 'none', padding: 0, display: 'flex', gap: '1rem' }}>
            ...
            <li><button id="nav-accounts">Accounts</button></li>
            <li><button id="nav-reports">Reports</button></li>
    ...
    children: (
      <div style={{ padding: '2rem' }}>
        ...
        <div style={{ marginTop: '2rem' }}>
          ...
          <button id="custom-calendar" style={{ marginLeft: '1rem' }}>Show Calendar</button>
          <button id="custom-search" style={{ marginLeft: '1rem' }}>Search</button>
        </div>
        ...
        <div style={{ marginTop: '2rem' }}>
          ...
          <button id="macro-export" style={{ marginLeft: '1rem' }}>Export Data</button>
        </div>
