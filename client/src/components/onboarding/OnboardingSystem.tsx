...
export const DEFAULT_ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    description:
      "Create your first journal entry or categorize a bank transaction",
    icon: FileText,
    estimatedTime: "1 min",
    required: true,
    completed: false,
...
export const DROPOFF_RECOVERY_HOOKS: Record<
  string,
    ...
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Complete these steps to get up and running. Estimated time:{" "}
        ...
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex-1">
                <p
                  className={`font-medium ${isCompleted ? "text-green-900 line-through" : "text-gray-900"}`}
                >
                  {step.title}
                </p>
      ...
      {showCelebration && (
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 mb-6">
            You've completed the setup. Time to value:{" "}
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Track customer activation progress
          </p>
        </div>
      ...
      <div className="space-y-4">
        {milestones.map((milestone) => {
          const progress = Math.min(
            (milestone.metric / milestone.target) * 100,
            100,
          );
            ...
            <div key={milestone.id} className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-1">
                  <span
                    className={`font-medium ${isComplete ? "text-green-900" : "text-gray-900"}`}
                  >
                    {milestone.name}
                  </span>
