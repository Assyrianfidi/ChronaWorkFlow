/**
 * AccuBooks Design System - Design Tokens
 * Modern SaaS design system following Stripe/Notion/Linear quality standards
 */
...
export const getShadow = (size: Shadow): string => {
