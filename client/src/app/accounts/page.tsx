...
export default function AccountsPage() {
  ...
  const accountColumns: Column<typeof accountsData[0]>[] = [
    ...
    },
    {
      ...
      render: (value) => {
        ...
        return (
          <span className={`px-2 py-1 rounded-full text-xs font-medium ${typeColors[value as keyof typeof typeColors] || "bg-gray-100 text-gray-800"}`}>
            {value}
          </span>
        );
      }
  ...
  const filteredAccounts = accounts.filter(account => {
    ...
    if (filters.balanceRange !== "all") {
      ...
      if (filters.balanceRange === "medium" && (balance < 50000 || balance > 100000)) return false;
    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Manage your business accounts and track balances</p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <EnterpriseInput
                      type="number"
                      placeholder="0.00"
                      defaultValue={editingAccount?.balance?.replace(/[$,]/g, '') || ""}
                      floatingLabel={false}
                    />
                  </div>
                </div>
