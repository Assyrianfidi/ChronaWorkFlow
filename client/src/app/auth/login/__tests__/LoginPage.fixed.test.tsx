...
const mockUseAuthStore = vi.fn<(selector?: (state: LoginPageAuthState) => any) => any>();
...
const createAuthState = (overrides: Partial<LoginPageAuthState> = {}): LoginPageAuthState => ({
  user: null,
  token: null,
...
const applyAuthState = (overrides: Partial<LoginPageAuthState>) => {
  ...
  mockUseAuthStore.mockImplementation((selector?: (state: LoginPageAuthState) => any) =>
...
describe('LoginPage', () => {
  ...
  it('submits the form with valid data', async () => {
    ...
    expect(mockLogin).toHaveBeenCalledWith({ email: testEmail, password: testPassword });
  });
