...
const mockUseAuthStore = vi.fn().mockImplementation((selector?: (state: typeof mockAuthState) => any) => {
...
describe('LoginPage', () => {
  ...
  beforeEach(() => {
    ...
    mockUseAuthStore.mockImplementation((selector?: (state: typeof mockAuthState) => any) => {
      return selector ? selector(mockAuthState) : mockAuthState;
    });
  });
  ...
  it('submits the form with valid data', async () => {
    ...
    const loginResponse = { user: { id: '1', email: testEmail }, token: 'test-token' };
