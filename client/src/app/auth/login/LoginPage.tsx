...
const theme = {
  ...
  shadows: {
    ...
    button: '0 4px 6px -1px rgba(30, 77, 183, 0.2), 0 2px 4px -1px rgba(30, 77, 183, 0.06)',
  },
};
    ...
    <div className="min-h-screen flex items-center justify-center p-4" 
      ...
      <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link href="/auth/forgot-password" className="text-sm font-medium text-[#1E4DB7] hover:text-[#1A4298] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to AccuBooks?</span>
              </div>
            </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} AccuBooks Enterprise. All rights reserved.</p>
          <div className="mt-2">
