...
describe('AuthContext', () => {
  ...
  it('should login successfully', async () => {
    const mockUser = { id: '1', email: 'test@example.com', firstName: 'Test', lastName: 'User', role: 'beginner' as const };
    const mockResponse = {
      data: {
        data: {
          user: mockUser,
          accessToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJleHAiOjk5OTk5OTk5OTl9.invalid',
    ...
    expect(localStorageMock.setItem).toHaveBeenCalledWith('accessToken', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJleHAiOjk5OTk5OTk5OTl9.invalid');
...
describe('TransactionsContext', () => {
  ...
  it('should create transaction', async () => {
    const mockTransaction = { id: '1', transactionNumber: 'TXN001', totalAmount: '100.00' };
