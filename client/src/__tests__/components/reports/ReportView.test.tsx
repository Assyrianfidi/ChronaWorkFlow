import { screen, renderWithProviders, getMockNavigate, resetMockNavigate } from '../../test-utils';
...
describe('ReportView', () => {
  ...
  it('renders report details correctly', async () => {
    ...
    // Check report title
    expect(await screen.findByRole('heading', { name: /q2 2023 financial report/i })).toBeInTheDocument();
    ...
    expect(screen.getByText(/this is a detailed financial report for q2 2023/i)).toBeInTheDocument();
