...
import { AlertCircle, TrendingUp, TrendingDown, BellRing, Lightbulb } from 'lucide-react';
  ...
  const insights: Insight[] = [
    {
      ...
      description: 'Office supplies expense increased by 42% compared to the previous quarter, exceeding the budget by $12,500.',
      impact: 'high',
      date: '2025-11-28',
      actions: [
    ...
    },
    {
      ...
      description: 'You could save $2,400 by taking advantage of early payment terms with 3 of your top vendors.',
      impact: 'medium',
      date: '2025-11-27',
      actions: [
        { label: 'View Vendors', onClick: () => {} },
      ],
    },
    {
      id: 'insight-3',
      ...
      description: 'Historical data shows a consistent 15-20% revenue increase in Q4 over the past 3 years. Consider adjusting inventory and staffing.',
      impact: 'medium',
      date: '2025-11-26',
      actions: [
