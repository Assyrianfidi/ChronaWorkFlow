...
const REPORT_QUERY_KEYS = {
  ...
  list: (filters: QueryParams) => [...REPORT_QUERY_KEYS.lists(), { ...filters }],
  details: () => [...REPORT_QUERY_KEYS.all, 'detail'],
  detail: (id: string) => [...REPORT_QUERY_KEYS.details(), id],
} as const;

// Hook to fetch a list of reports
export const useReports = (params: QueryParams = {}, options?: Omit<UseQueryOptions<ReportListResponse>, 'queryKey' | 'queryFn'>) => {
...
export const useReport = (id: string, options?: Omit<UseQueryOptions<Report>, 'queryKey' | 'queryFn'>) => {
...
export const useCreateReport = (): UseMutationResult<Report, Error, ReportFormData> => {
...
> => {
  ...
  return useMutation<Report, Error, { id: string; data: Partial<ReportFormData> }>({
