...
import { dashboardService, type DashboardKPI, type Invoice, type Transaction, type Customer, type ExpenseCategory, type CashFlowData } from "../services/dashboard.service"
...
const fetcher = async (key: string) => {
  ...
  return await serviceInstance[method as keyof typeof dashboardService](...params)
}
...
// Dashboard KPIs Hook
export function useDashboardKPIs(period: "7-day" | "30-day" | "quarter" = "30-day") {
...
// Analytics Hooks
export function useExpenseBreakdown(period: "month" | "quarter" | "year" = "month") {
...
export function useCashFlow(period: "6-months" | "12-months" | "24-months" = "6-months") {
...
export function useRealTimeData<T>(key: string, fetcher: () => Promise<T>, interval: number = 5000) {
