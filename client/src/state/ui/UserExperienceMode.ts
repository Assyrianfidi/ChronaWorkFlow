...
export class AdaptiveUIEngine {
  ...
  private getPatternAdaptations(): Partial<UIAdaptationConfig> {
    ...
    if (patterns.averageSessionDuration > 1800) {
      // 30 minutes
  ...
  public shouldShowFeature(
    feature: keyof UIAdaptationConfig["features"],
  ): boolean {
    return this.currentConfig.features[feature];
  }

  public shouldShowGuidance(
    guidance: keyof UIAdaptationConfig["guidance"],
  ): boolean {
