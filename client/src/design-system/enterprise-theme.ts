...
export const enterpriseColors = {
  ...
  surface: {
    ...
    2: "#F3F4F6", // surface-2: panels / sections
    3: "#E5E7EB", // surface-3: dividers / subtle chrome
  },
...
export const shadows = {
  ...
  cardHover:
    "0 10px 15px -3px rgb(30 77 183 / 0.15), 0 4px 6px -4px rgb(30 77 183 / 0.15)",
  sidebar: "4px 0 6px -4px rgb(30 77 183 / 0.1)",
  header: "0 4px 6px -1px rgb(30 77 183 / 0.1)",
  "glass-card":
    "0 8px 32px 0 rgb(30 77 183 / 0.1), 0 2px 8px 0 rgb(30 77 183 / 0.05)",
};
...
export const enterpriseTheme = {
  ...
  shadows,
  animation,
  // High-level component semantics to be used by Tailwind utilities / components
  components: {
    card: {
      background: "#FFFFFF",
      borderColor: "#E5E7EB",
    ...
    buttons: {
      primary: {
        background: "linear-gradient(135deg, #1E4DB7 0%, #0d1f4d 100%)",
        color: "#FFFFFF",
        borderColor: "#1E4DB7",
      },
      secondary: {
