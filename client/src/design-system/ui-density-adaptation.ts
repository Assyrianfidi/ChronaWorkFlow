...
export class UIDensityAdaptationEngine {
  ...
  private calculateOptimalProfile(): UIDensityProfile {
    ...
    let inputScale = 1;
    let informationDensity: UIDensityProfile["information"]["kpiRichness"] =
      "standard";
  ...
  private applyCSSVariables(): void {
    ...
    root.style.setProperty(
      "--spacing-comfortable",
      `${profile.spacing.comfortable}px`,
    );
    root.style.setProperty(
      "--spacing-spacious",
      `${profile.spacing.spacious}px`,
    );

    // Apply typography variables
    root.style.setProperty(
      "--typography-scale",
      profile.typography.scale.toString(),
    );
    root.style.setProperty(
      "--font-weight-light",
      profile.typography.weight.light.toString(),
    );
    root.style.setProperty(
      "--font-weight-normal",
      profile.typography.weight.normal.toString(),
    );
    root.style.setProperty(
      "--font-weight-medium",
      profile.typography.weight.medium.toString(),
    );
    root.style.setProperty(
      "--font-weight-semibold",
      profile.typography.weight.semibold.toString(),
    );
    root.style.setProperty(
      "--font-weight-bold",
      profile.typography.weight.bold.toString(),
    );
    root.style.setProperty(
      "--line-height",
      profile.typography.lineHeight.toString(),
    );
    root.style.setProperty(
      "--letter-spacing",
      `${profile.typography.letterSpacing}px`,
    );
    ...
    root.style.setProperty(
      "--input-border-radius",
      `${profile.inputs.borderRadius}px`,
    );
    root.style.setProperty(
      "--input-border-width",
      `${profile.inputs.borderWidth}px`,
    );
    ...
    root.style.setProperty(
      "--card-padding",
      `${profile.components.cardPadding}px`,
    );
    root.style.setProperty(
      "--table-row-height",
      `${profile.components.tableRowHeight}px`,
    );
    root.style.setProperty(
      "--sidebar-width",
      `${profile.components.sidebarWidth}px`,
    );
    root.style.setProperty(
      "--header-height",
      `${profile.components.headerHeight}px`,
    );
  ...
  getTypography(
    weight: keyof UIDensityProfile["typography"]["weight"],
  ): number {
